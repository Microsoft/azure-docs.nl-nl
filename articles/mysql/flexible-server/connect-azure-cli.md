...
U kunt aanvullende argumenten opgeven voor deze opdracht om deze aan te passen. Bekijk alle argumenten voor [AZ mysql Flexible-server Create](/cli/azure/mysql/flexible-server?view=azure-cli-latest#az_mysql_flexible_server_create).
