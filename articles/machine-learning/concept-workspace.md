...
* De [Azure machine learning SDK voor python](how-to-manage-workspace.md?tabs=python#create-a-workspace) gebruiken om een werk ruimte te maken in de vlucht vanuit Python-scripts of Jupyter-notebooks
