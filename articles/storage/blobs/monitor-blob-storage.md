...
Hier volgen enkele query's die u kunt invoeren in de **Zoek** balk van het logboek om u te helpen bij het bewaken van de Blob-opslag. Deze query's werken met de [nieuwe taal](../../azure-monitor/log-query/log-query-overview.md).
