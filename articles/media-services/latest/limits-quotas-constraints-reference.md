...
| Resource | Standaardlimiet | 
| --- | --- | 
| [Taken](transform-jobs-concept.md) per Media Services-account | 500.000 <sup>(3)</sup> (vast)|
| Taakinvoer per taak | 50 (vast)|
| Taakuitvoer per taak | 20 (vast) |
| [Trans formaties](transform-jobs-concept.md) per Media Services account | 100 (vast)|
...
| Resource | Standaardlimiet | 
| --- | --- | 
| [Live-gebeurtenissen](live-event-outputs-concept.md) <sup>(4)</sup> per Media Services-account |5|
| Live-uitvoer per livegebeurtenis |3 <sup>(5)</sup> |
| Maximale duur van live-uitvoer | [Grootte van het DVR-venster](live-event-cloud-dvr-time-how-to.md) |

<sup>4</sup> Zie [vergelijking van live-gebeurtenis typen en limieten](live-event-types-comparison-reference.md)voor meer informatie over limieten voor Live-gebeurtenissen.
...
| Resource | Standaardlimiet |
| --- | --- |
| [Streaming-eind punten](stream-streaming-endpoint-concept.md) (gestopt of actief) per Media Services-account | 2 |
| Premium-streaming-eenheden | 10 |
| [Dynamisch-manifestfilters](filters-dynamic-manifest-concept.md)|100|
| [Beleid voor streaming](stream-streaming-policy-concept.md) | 100 <sup>(6)</sup> |
| Unieke [streaming-Locators](stream-streaming-locators-concept.md) die zijn gekoppeld aan een asset in één keer | 100<sup>(7)</sup> (vast) |
