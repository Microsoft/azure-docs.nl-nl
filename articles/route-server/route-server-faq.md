...
Zie voor meer informatie [een probleem met de route ring van een Azure virtual machine diagnosticeren](../virtual-network/diagnose-network-routing-problem.md).
