...
### <a name="select-solution-areas"></a>Oplossings gebieden selecteren

Oplossings gebieden helpen u bij het verder bepalen van uw oplossing. Zo kunnen micro soft-verkoop teams de toegevoegde waarde van de oplossing vinden en begrijpen. U moet ten minste één en Maxi maal drie oplossings gebieden voor uw aanbieding selecteren. Voor elk oplossings gebied kunt u Maxi maal twee subgebieden voor de oplossing kiezen.

1. Selecteer de koppeling **+ oplossings gebied toevoegen (3 Max)** .
1. Selecteer een oplossings gebied in de vervolg keuzelijst die wordt weer gegeven.
1. Selecteer ten minste één en Maxi maal twee subgebieden voor de oplossing. Als u meerdere subgebieden wilt selecteren, gebruikt u de `Ctrl` sleutel (op Windows) of de `Command` sleutel (op macOS).
1. Herhaal de stappen 1 tot en met 3 om een ander oplossings gebied toe te voegen.

## <a name="upload-documents"></a>Documenten uploaden

U moet liquide documenten opgeven met details over uw aanbieding. Micro soft verkoop teams gebruiken deze informatie om te evalueren of uw aanbieding geschikt is voor de behoeften van klanten, zodat u uw aanbieding kunt aanbevelen en verkopen. Hoe meer informatie u verstrekt, hoe meer informatie micro soft verkoop teams nodig heeft om uw product te begrijpen en te promoten.

De ondersteunde bestands typen zijn. PDF,. ppt,. PPTX,. doc,. docx,. xls,. xlsx,. jpg,. png en. MP4. De sjablonen voor sommige documenten vindt u in onderstaande tabel 2.

> [!NOTE]
> De **oplossing voor één paginerings-** en **oplossings-en aanbod aanbieding** is vereist om de status van de samen verkoop gereed te maken. Ze zijn ook vereisten voor sommige aanbiedingen van Azure IP-gemotiveerd. Het referentie architectuur diagram is ook vereist voor de gemotiveerd-status van Azure IP-verkoop. De andere documenten die in deze tabel worden beschreven, zijn optioneel, maar aanbevolen.

***Tabel 2: documenten die co-sell ondersteunen***

| **Documenten**    | **Beschrijving**  |
| :------------------- | :-------------------|
| *Oplossing/aanbieding met één pager (vereist)* | Bewaak het inzicht onder potentiële klanten met een professioneel ontworpen one-pager die de toegevoegde waarde van uw oplossing laat zien.<br><br>U kunt een van de volgende sjablonen gebruiken om een door de klant gereed beschrijving van uw aanbieding te bieden:<br><ul><li> [Microsoft Azure sjabloon met één pager](https://aka.ms/Customer-One-Pager_MicrosoftAzure)</li><li>[Micro soft Dynamics 365 1-pager sjabloon](https://aka.ms/Customer-One-Pager_MicrosoftDynamics365)</li> <li>[Micro soft 365 1-pager sjabloon](https://aka.ms/Customer-One-Pager_MicrosoftOffice365) </li><li>[Windows 10 1-pager sjabloon](https://aka.ms/Customer-One-Pager_Windows)</li></ul> <br> Micro soft verkoop teams kunnen deze informatie delen met klanten om te helpen bepalen of uw aanbieding goed kan worden aangepast en om ervoor te zorgen dat de klant klaar is. |
| *Het deck-aanbod voor oplossingen/aanbiedingen (vereist)* | U kunt de sjabloon voor de [klant presentatie](https://aka.ms/GTMServices_CustomerPresentation) gebruiken om uw eigen deck te maken. Dit deck moet verwijzen naar het diagram van de [referentie architectuur](reference-architecture-diagram.md). Het doel van dit diapresentatie is om te verkopen op uw aanbieding en de toegevoegde waarde. Nadat u hebt gecontroleerd of uw aanbieding klant klaar is, kunnen micro soft-verkoop teams deze presentatie delen met klanten om de waarde te geleeren die uw bedrijf en micro soft meebrengen bij het implementeren van een gemeen schappelijke oplossing. De presentatie moet voldoen aan de eisen van uw aanbieding, hoe IT de klanten kan helpen, welke branches voor de aanbieding relevant zijn en hoe deze worden vergeleken met concurrerende oplossingen. |
| *Casestudy* van de klant (optioneel)| Gebruik de casestudy [sjabloon](https://aka.ms/GTM_Case_Study_Template) om uw casestudy voor de klant te maken. Deze informatie toont een mogelijke klant hoe u en micro soft uw aanbieding in eerdere gevallen succesvol heeft geïmplementeerd. |
| *Verifieer bare klant-WINS* (optioneel) | Geef specifieke voor beelden van klant successen nadat uw aanbieding is geïmplementeerd. |
| *Channel pitch-dek* (optioneel) | Een diapresentatie met informatie waarmee Channel-wederverkopers meer weten over uw aanbieding en hun verkoop teams kunnen helpen om deze te verkopen. Deze deck bevat doorgaans een lift, informatie over doel klanten, vragen om klanten, pratende punten en koppelingen naar Video's, documentatie en ondersteunings informatie te vragen. |
| *Referentie architectuur diagram* (vereist voor Azure IP co-gemotiveerd-status) | Een diagram dat staat voor uw aanbieding en de relatie met micro soft-Cloud Services. Het kan ook aantonen hoe uw aanbieding voldoet aan de technische vereisten voor de gemotiveerd-status van Azure IP co-sell. [Meer informatie over het diagram voor referentie architectuur.](reference-architecture-diagram.md) |
| *Andere documenten* (optioneel) | U kunt Maxi maal vijf extra documenten of Video's uploaden om micro soft verkoop teams en Channel wederverkopers te helpen meer te weten komen over uw aanbieding, organisatie en hoe deze verschillen van andere aanbiedingen. |
|||

- Nadat u uw documenten hebt gemaakt, sleept u deze naar het juiste vak onder **documenten** of selecteert u **Bladeren in uw bestand (en)** om een document van uw computer te uploaden.

    [![Illustreert het gedeelte over het verkopen van documenten van het tabblad samen verkopen met micro soft.](./media/co-sell/co-sell-documents-section.png)](./media/co-sell/co-sell-documents-section.png#lightbox)

## <a name="product-landing-page"></a>Landings pagina van product
...
1. Open de. CSV-bestand in een toepassing, zoals micro soft Excel, en vul elke rij in met informatie over de contact persoon.
    ...
    ***Tabel 3: beschrijving van rollen***
    ...
    - Landen/regio's (vereist): gebruik bij het invullen van de sjabloon de [land-en regio codes](commercial-marketplace-co-sell-countries.md)van de twee letters co-sell. Als de contact persoon alle landen en regio's omvat, gebruikt u de drie-letter code ' OOO '. Als een contact persoon meer dan een land of regio bevat, voert u elk van de twee letters van elkaar gescheiden door een komma in. Typ bijvoorbeeld ' US, CA, FR ' zonder aanhalings tekens in de sjabloon.
        ...
        De landen en regio's moeten overeenkomen met het rayon van elke contact persoon. Micro soft verkoop teams en Channel-wederverkopers gebruiken deze informatie bij het aanvragen van gegevens of het samen werken aan verkoop binnen het specifieke land of de desbetreffende regio.
