...
| Kenmerk | Vereist | Beschrijving |
| --------- | -------- | ----------- |
| De naam van de HTTP-header, zoals `x-functions-key` of `x-api-key` . | Yes | De sleutel die wordt gebruikt om te verifiëren. |
