...
- Oracle-implementaties in Oracle Linux-gast besturingssysteem met [dNFS](https://docs.oracle.com/en/database/oracle/oracle-database/19/ntdbi/creating-an-oracle-database-on-direct-nfs.html#GUID-2A0CCBAB-9335-45A8-B8E3-7E8C4B889DEA) voor Oracle-gegevens en logboek volumes opnieuw uitvoeren. Meer informatie vindt u in het artikel [Azure virtual machines Oracle DBMS-implementatie voor SAP-workload](./dbms_guide_oracle.md)
