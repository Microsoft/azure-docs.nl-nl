---
title: Azure Policy controles voor naleving van regelgeving voor Azure Spring Cloud
description: Een Azure Policy beschikbare besturingselementen voor naleving van regelgeving voor Azure Spring Cloud. Deze ingebouwde beleidsdefinities bieden algemene benaderingen voor het beheren van de naleving van uw Azure-resources.
ms.date: 04/21/2021
ms.topic: sample
author: bmitchell287
ms.author: brendm
...
ms.locfileid: "107870157"
---
# <a name="azure-policy-regulatory-compliance-controls-for-azure-spring-cloud"></a>Azure Policy controles voor naleving van regelgeving voor Azure Spring Cloud

[Naleving van regelgeving in Azure Policy](../governance/policy/concepts/regulatory-compliance.md) biedt door Microsoft gemaakte en beheerde initiatiefdefinities, bekend als _ingebouwde modules_, voor de **nalevingsdomeinen** en **beveiligingsmaatregelen** met betrekking tot verschillende nalevingsstandaarden. Op deze pagina worden de **nalevingsdomeinen en** **beveiligingsmaatregelen voor** Azure Spring Cloud. U kunt de ingebouwde modules voor een **beveiligingsmaatregel** afzonderlijk toewijzen om uw Azure-resources de specifieke standaard te laten naleven.
