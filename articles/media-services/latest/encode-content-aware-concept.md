...
![Distorsie (RD)-curve met behulp van PSNR](media/encode-content-aware-concept/msrv1.png)

**Afbeelding 1: een bocht-curve (distorsie) met behulp van PSNR-metrische gegevens voor een hoge complexiteits bron**

![Distorsie (RD)-curve met behulp van VMAF](media/encode-content-aware-concept/msrv2.png)
...
![RD-curve met PSNR](media/encode-content-aware-concept/msrv3.png)

**Afbeelding 3: RD-curve met PSNR voor invoer van lage kwaliteit (op 1080p)**

![RD-curve met VMAF](media/encode-content-aware-concept/msrv4.png)
