...
- [Best practices voor Azure Active Directory B2B](b2b-fundamentals.md)
- [Externe B2B-samenwerking inschakelen en beheren wie gasten kan uitnodigen](delegate-invitations.md)
...
- [Externe identiteiten Azure Active Directory: wat is er nieuw](whats-new-docs.md)
- [Uitnodigingen aan B2B-gebruikers van specifieke organisaties toestaan of blokkeren](allow-deny-list.md)
- [Azure Active Directory B2B-samenwerkings-API en-aanpassing](customize-invitation-api.md)
- [Interne gebruikers uitnodigen voor B2B-samen werking](invite-internal-users.md)
- [Microsoft 365 extern delen en Azure Active Directory (Azure AD) B2B-samen werking](o365-external-user.md)
- [Directe Federatie met AD FS en providers van derden voor gast gebruikers (preview-versie)](direct-federation.md)
...
- [Uitnodigingen aan B2B-gebruikers van specifieke organisaties toestaan of blokkeren](allow-deny-list.md)
- [Veelgestelde vragen over Azure Active Directory B2B-samen werking](faq.md)
- [Documentatie voor externe identiteiten](index.yml)
- [Uitnodigingsinwisseling voor Azure Active Directory B2B-samenwerking](redemption-experience.md)
- [Een aangepaste goedkeurings werk stroom toevoegen aan self-service registratie](self-service-sign-up-add-approvals.md)
- [Wat zijn externe identiteiten in Azure Active Directory?](compare-with-b2c.md)
- [Een API-connector toevoegen aan een gebruikers stroom](self-service-sign-up-add-api-connector.md)
...
### <a name="updated-articles"></a>Bijgewerkte artikelen
- [De elementen van het e-mail adres uitnodiging voor B2B-samen werking-Azure Active Directory](invitation-email-elements.md)
- [Problemen oplossen Azure Active Directory B2B-samen werking](troubleshoot.md)
- [Facturerings model voor externe Azure AD-identiteiten](external-identities-pricing.md)
- [Google toevoegen als een id-provider voor B2B-gast gebruikers](google-federation.md)
