...
Elke training genereert automatisch 100-voorbeeld audio om u te helpen bij het testen van het model. Nadat u het spraak model hebt gemaakt, kunt u het testen voordat u het implementeert voor gebruik.

1.  Navigeer naar **tekst-naar-spraak > aangepaste spraak > [naam van project] > model**.

2.  Klik op de naam van het model dat u wilt testen.

3.  Op de detail pagina van het model vindt u de voor beeld-audio op het tabblad **testen** . 
