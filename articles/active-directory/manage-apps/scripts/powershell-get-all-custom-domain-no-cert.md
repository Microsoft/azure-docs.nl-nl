...
ms.locfileid: "107377137"
---
# <a name="get-all-application-proxy-apps-published-with-no-certificate-uploaded"></a>Alle apps toepassingsproxy gepubliceerd zonder certificaat te uploaden
