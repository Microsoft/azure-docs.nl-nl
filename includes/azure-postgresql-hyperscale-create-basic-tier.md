...
4. Vul het formulier voor de gegevens van de nieuwe server als volgt in:
   ...
   - Activeer het selectie vakje en **Schakel preview-functies in**.
...
5. Klik op **Servergroep configureren**.
   - Selecteer het keuze rondje **basis** voor de **laag**.
   - Klik op **Opslaan**.
