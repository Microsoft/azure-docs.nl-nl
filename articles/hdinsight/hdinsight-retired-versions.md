---
title: In azure HDInsight gedeactiveerde versies
description: Meer informatie over de buiten gebruik gestelde versies in azure HDInsight.
...
ms.locfileid: "103490242"
---
# <a name="retired-hdinsight-versions"></a>Verouderde HDInsight-versies

In dit artikel vindt u meer informatie over de buiten gebruik gestelde versies in HDInsight.

## <a name="retired-version-list"></a>Lijst met ingetrokken versies

De volgende tabel geeft een lijst van de buiten gebruik gestelde versies van HDInsight.
...
- [Ondersteunde Apache-onderdelen en versies in HDInsight](./hdinsight-component-versioning.md)
