...
| token_signing_algorithm | No | Het handtekening algoritme dat wordt gebruikt voor client verklaringen wanneer de **token_endpoint_auth_method** meta gegevens worden ingesteld op `private_key_jwt` . Mogelijke waarden: `RS256` (standaard). |
