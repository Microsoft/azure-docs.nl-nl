...
1. Voer op het scherm **Git-opslagplaats voor broncode** in het vak **URI** het webadres https://github.com/Azure-Samples/azure-cosmos-java-sql-api-todo-app in en klik vervolgens op **Volgende**.
