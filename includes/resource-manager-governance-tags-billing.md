...
U kunt ook het [overzicht van Azure-verbruiks-API](../articles/cost-management-billing/manage/consumption-api-overview.md) gebruiken om kosten programmatisch weer te geven.
