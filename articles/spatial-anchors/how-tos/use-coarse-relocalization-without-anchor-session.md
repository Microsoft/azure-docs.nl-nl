---
title: Grove relokalisatie zonder een anker sessie gebruiken
description: Grove relokalisatie zonder een anker sessie gebruiken
author: msftradford
...
Het sensor fingerprint provider-object dat deel uitmaakt van de functie [grof relokalisatie](../concepts/coarse-reloc.md) , kan worden gebruikt zonder te zijn gekoppeld aan een Azure spatiale-ankers sessie.
Het volgende code fragment laat zien hoe de sensor provider toegang kan krijgen tot het verkrijgen van een schatting van de positie van het apparaat:
