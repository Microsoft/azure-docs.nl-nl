...
ms.locfileid: "106275614"
---
# <a name="download-the-results-of-a-job"></a>De resultaten van een taak downloaden

[!INCLUDE [media services api v3 logo](./includes/v3-hr.md)]

In Azure Media Services moet u bij het verwerken van uw Video's (bijvoorbeeld code ring of analyse) een uitvoer [activum](assets-concept.md) maken om het resultaat van uw [taak](transform-jobs-concept.md)op te slaan. U kunt deze resultaten vervolgens downloaden naar een lokale map met behulp van media service en opslag-Api's. 
