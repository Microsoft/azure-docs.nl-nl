...
* [Azure DNS CLI voor persoonlijke zones](/cli/azure/network/private-dns/link/vnet)
* [Azure DNS persoonlijke zones Power shell](/powershell/module/az.privatedns/)
* [Azure DNS-SDK voor particuliere zones](/dotnet/api/overview/azure/privatedns/management)
