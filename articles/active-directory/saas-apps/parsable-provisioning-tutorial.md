---
title: 'Zelf studie: Parseerbare configureren voor het automatisch inrichten van gebruikers met Azure Active Directory | Microsoft Docs'
description: Meer informatie over het automatisch inrichten en ongedaan maken van de inrichting van gebruikers accounts van Azure AD naar Parseerbare.
...
In deze zelf studie worden de stappen beschreven die u moet uitvoeren in zowel Parseerbare als Azure Active Directory (Azure AD) voor het configureren van automatische gebruikers inrichting. Wanneer de configuratie is geconfigureerd, worden gebruikers en groepen door Azure AD automatisch ingericht en [Geparseerbared](https://www.parsable.com/) met behulp van de Azure AD-inrichtings service. Zie voor belangrijke details over wat deze service doet, hoe het werkt en veelgestelde vragen [Inrichting en ongedaan maken van inrichting van gebruikers automatiseren naar SaaS-toepassingen met Azure Active Directory](../manage-apps/user-provisioning.md). 
...
* Een Parseerbare-Tenant (team).
* Een gebruikers account in Parseerbare met beheerders machtigingen.
...
3. Bepaal welke gegevens moeten worden [toegewezen tussen Azure AD en parseerbare](https://docs.microsoft.com/azure/active-directory/manage-apps/customize-application-attributes). 

## <a name="step-2-configure-parsable-to-support-provisioning-with-azure-ad"></a>Stap 2. Parseerbare configureren voor ondersteuning bij het inrichten met Azure AD

1. Neem contact op met de Parseerbare van de klant om u aan te melden bij deze voorlopige versie.
2. Ze helpen u bij het verhogen van een ondersteunings ticket voor het verkrijgen van het vereiste **Bearer-token** (geheim token).
3. Kopieer het **Bearer token** en sla het op. Deze waarde wordt ingevoerd in het veld **geheim token** * op het tabblad inrichten van uw parseerbare-toepassing in de Azure Portal.

## <a name="step-3-add-parsable-from-the-azure-ad-application-gallery"></a>Stap 3. Parseerbare toevoegen vanuit de Azure AD-toepassings galerie

Voeg Parseerbare toe vanuit de Azure AD-toepassings galerie om het beheren van de inrichting van Parseerbare te starten. Als u eerder Parseerbare voor SSO hebt ingesteld, kunt u dezelfde toepassing gebruiken. U wordt echter aangeraden een afzonderlijke app te maken wanneer u de integratie voor het eerst test. Klik [hier](https://docs.microsoft.com/azure/active-directory/manage-apps/add-gallery-app) voor meer informatie over het toevoegen van een toepassing uit de galerie. 
...
## <a name="step-5-configure-automatic-user-provisioning-to-parsable"></a>Stap 5. Automatische gebruikers inrichting configureren voor Parseerbare 
...
### <a name="to-configure-automatic-user-provisioning-for-parsable-in-azure-ad"></a>Automatische gebruikers inrichting configureren voor Parseerbare in azure AD:

1. Meld u aan bij de [Azure-portal](https://portal.azure.com). Selecteer **Bedrijfstoepassingen** en vervolgens **Alle toepassingen**.

    ![De blade Bedrijfstoepassingen](common/enterprise-applications.png)

2. Selecteer in de lijst toepassingen de optie **parseerbare**.

    ![De koppeling Parseerbare in de lijst met toepassingen](common/all-applications.png)
...
5. Geef in het gedeelte **beheerders referenties** de Parseerbare-TENANT-URL en het geheime token op. Klik op **verbinding testen** om te controleren of Azure AD verbinding kan maken met parseerbare. Als de verbinding mislukt, zorg er dan voor dat uw Parseerbare-account beheerders machtigingen heeft en probeer het opnieuw.
...
8. Selecteer in de sectie **toewijzingen** de optie **Azure Active Directory gebruikers synchroniseren met parseerbare**.

9. Controleer de gebruikers kenmerken die zijn gesynchroniseerd vanuit Azure AD naar Parseerbare in de sectie **kenmerk toewijzing** . De kenmerken die zijn geselecteerd als **overeenkomende** eigenschappen worden gebruikt om te voldoen aan de gebruikers accounts in parseerbare voor bijwerk bewerkingen. Als u ervoor kiest om het [overeenkomende doel kenmerk](https://docs.microsoft.com/azure/active-directory/manage-apps/customize-application-attributes)te wijzigen, moet u ervoor zorgen dat de PARSEERBARE-API het filteren van gebruikers op basis van dat kenmerk ondersteunt. Selecteer de knop **Opslaan** om eventuele wijzigingen door te voeren.
