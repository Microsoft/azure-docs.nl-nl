...
* U kunt Microsoft Mijn apps gebruiken. Wanneer u op de tegel HSB-ThoughtSpot in de mijn apps klikt, wordt dit omgeleid naar de URL voor HSB ThoughtSpot-aanmelding. Zie [Introduction to My Apps](../user-help/my-apps-portal-end-user-access.md) (Inleiding tot Mijn apps) voor meer informatie over Mijn apps.
