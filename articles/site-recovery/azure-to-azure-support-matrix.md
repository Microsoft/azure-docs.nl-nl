...
De volgende tabel bevat de limieten voor het aantal schijven dat kan worden gerepliceerd naar één opslag account.

**Type opslag account**    |    **Verloop = 4 MBps per schijf**    |    **Verloop = 8 MBps per schijf**
---    |    ---    |    ---
V1-opslag account    |    300-schijven    |    150-schijven
V2-opslag account    |    750-schijven    |    375-schijven

Naarmate het gemiddelde verloop op de schijven toeneemt, wordt het aantal schijven dat een opslag account kan ondersteunen vermindert. De bovenstaande tabel kan worden gebruikt als richt lijn voor het nemen van beslissingen over het aantal opslag accounts dat moet worden ingericht.

Houd er rekening mee dat de bovenstaande limieten specifiek zijn voor Azure naar Azure en de zone voor DR-scenario's voor zones. 
...
|||
20,04 LTS |[9,41](https://support.microsoft.com/en-us/topic/update-rollup-54-for-azure-site-recovery-50873c7c-272c-4a7a-b9bb-8cd59c230533)| 5.4.0-26-algemeen naar 5.4.0-65 </br> -generic 5.4.0-1010-Azure naar 5.4.0-1039-Azure </br> 5.8.0-29-generic naar 5.8.0-43-generic </br> 5.4.0-66-generic, 5.4.0-67-generic, 5.4.0-70-algemeen, 5.8.0-44-generic, 5.8.0-45-algemeen, 5.8.0-48-generic, 5.4.0-1040-Azure, 5.4.0-1041-Azure, 5.4.0-1043-Azure tot en met 9,41 Hot Fix patch * *|
20,04 LTS |[9,40](https://support.microsoft.com/en-us/topic/update-rollup-53-for-azure-site-recovery-060268ef-5835-bb49-7cbc-e8c1e6c6e12a)| 5.4.0-26-generic naar 5.4.0-59 </br> -generic 5.4.0-1010-Azure naar 5.4.0-1035-Azure </br> 5.8.0-29-generic naar 5.8.0-34-generic </br> 5.4.0-1036-Azure, 5.4.0-60-generic, 5.4.0-62-algemeen, 5.8.0-36-algemeen, 5.8.0-38-generic, 5.4.0-1039-Azure, 5.4.0-64-Gene riek, 5.4.0-65-generic, 5.8.0-40-algemeen, 5.8.0-41-generic tot en met 9,40 Hot Fix patch * *|
...
|||
Debian 9,1 | [9,41](https://support.microsoft.com/en-us/topic/update-rollup-54-for-azure-site-recovery-50873c7c-272c-4a7a-b9bb-8cd59c230533) | 4.9.0-1-amd64 tot 4.9.0-14-amd64 </br> 4.19.0 -0. bpo. 1-amd64 to 4.19.0 -0. bpo. 14-amd64 </br> 4.19.0 -0. bpo. 1-Cloud-amd64 to 4.19.0 -0. bpo. 14-Cloud-amd64 </br> 4.9.0-15-amd64, 4.19.0 -0. bpo. 16-amd64, 4.19.0 -0. bpo. 16-Cloud-amd64 tot en met 9,41 Hot Fix patch * *
Debian 9,1 | [9,40](https://support.microsoft.com/en-us/topic/update-rollup-53-for-azure-site-recovery-060268ef-5835-bb49-7cbc-e8c1e6c6e12a) | 4.9.0-1-amd64 tot 4.9.0-14-amd64 </br> 4.19.0 -0. bpo. 1-amd64 to 4.19.0 -0. bpo. 13-amd64 </br> 4.19.0 -0. bpo. 1-Cloud-amd64 to 4.19.0 -0. bpo. 13-Cloud-amd64 
...
**Release** | **Mobility Service-versie** | **Kernelversie** |
--- | --- | --- |
SUSE Linux Enterprise Server 12 (SP1, SP2, SP3, SP4, SP5) | [9,41](https://support.microsoft.com/en-us/topic/update-rollup-54-for-azure-site-recovery-50873c7c-272c-4a7a-b9bb-8cd59c230533) | Alle [Stock-SuSE 12 SP1, SP2, SP3, SP4, SP5-kernels](https://www.suse.com/support/kb/doc/?id=000019587) worden ondersteund.</br></br> 4.4.138-4.7-Azure naar 4.4.180-4.31-Azure,</br>4.12.14-6.3-Azure naar 4.12.14-6.43-Azure </br> 4.12.14-16,7-Azure naar 4.12.14-16.44-Azure </br> 4.12.14-16.47-Azure via 9,41 Hot Fix patch * *|
