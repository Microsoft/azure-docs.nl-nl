---
title: AWS-exemplaren evalueren voor migratie naar Azure met Azure Migrate
description: Meer informatie over het openen van AWS-instanties voor migratie naar Azure met Azure Migrate.
author: rashi-ms
ms.author: rajosh
ms.manager: abhemraj
ms.topic: tutorial
...
Dit artikel laat u zien hoe u Amazon Web Services-exemplaren (AWS) kunt beoordelen voor migratie naar Azure met behulp van het hulp programma Azure Migrate: detectie en evaluatie.
...
- Zorg ervoor dat AWS-exemplaren geen Windows Server 2003 of SUSE Linux uitvoeren. De evaluatie wordt niet ondersteund voor deze servers.
