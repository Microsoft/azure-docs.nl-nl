...
Een GitHub actions- [werk stroom](https://docs.github.com/en/actions/learn-github-actions/introduction-to-github-actions#the-components-of-github-actions) definieert een geautomatiseerd proces in een github-opslag plaats. Met de actie voor het *synchroniseren van Azure-app-configuratie* worden updates voor een app-configuratie-exemplaar geactiveerd wanneer er wijzigingen in de bron opslagplaats worden aangebracht. Er wordt een YAML-bestand (. yml) gebruikt dat is gevonden in het `/.github/workflows/` pad van uw opslag plaats om de stappen en para meters te definiëren. U kunt configuratie-updates activeren tijdens het pushen, reviseren of vertakking van app-configuratie bestanden, net als bij app-code.

De GitHub- [documentatie](https://docs.github.com/en/actions/learn-github-actions/introduction-to-github-actions) biedt uitgebreide weer gave van github-werk stromen en-acties. 
