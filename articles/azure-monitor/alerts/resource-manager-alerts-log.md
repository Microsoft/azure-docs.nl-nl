...
Met het volgende voorbeeld wordt een [waarschuwingsregel voor aantal resultaten](../alerts/alerts-unified-log.md#count-of-the-results-table-rows) gemaakt.

### <a name="notes"></a>Opmerkingen

- Dit voorbeeld bevat een [webhookpayload](../alerts/alerts-log-webhook.md). Als de waarschuwingsregel geen webhook moet activeren, verwijdert u het element **customWebhookPayload**.
...
Met het volgende voorbeeld wordt een [waarschuwingsregel voor metrische gegevens](../alerts/alerts-unified-log.md#calculation-of-measure-based-on-a-numeric-column-such-as-cpu-counter-value) gemaakt.
