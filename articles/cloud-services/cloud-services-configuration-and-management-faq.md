...
```
De mogelijkheid om BLOB of lokaal te kiezen voor uw csdef-en cscfg-upload locatie is binnenkort beschikbaar. Met behulp van [New-Azure](/powershell/module/servicemanagement/azure.service/new-azuredeployment)kunt u elke locatie waarde instellen.
