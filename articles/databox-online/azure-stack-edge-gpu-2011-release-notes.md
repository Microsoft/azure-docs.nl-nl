---
title: Release opmerkingen bij Azure Stack Edge Pro 2011
description: Hierin worden essentiële openstaande problemen en oplossingen voor de Azure Stack Edge Pro-versie van 2011 beschreven.
services: databox
author: alkohli
ms.service: databox
ms.subservice: edge
...
ms.locfileid: "96466568"
---
# <a name="azure-stack-edge-2011-release-notes"></a>Release opmerkingen bij Azure Stack Edge 2011

De volgende opmerkingen bij de release identificeren de kritieke openstaande problemen en de opgeloste problemen voor de 2011-release voor uw Azure Stack edge-apparaten. Deze release opmerkingen zijn van toepassing op Azure Stack Edge Pro GPU, Azure Stack Edge Pro R en Azure Stack Edge mini-R-apparaten. Functies en problemen die overeenkomen met een specifiek model, worden waar van toepassing aangeroepen.
...
Dit artikel is van toepassing op de **Azure stack Edge 2011** -release<!--which maps to software version number **2.1.XXXX.XXXX**-->.

## <a name="whats-new"></a>Nieuwe functies

De volgende nieuwe functies zijn beschikbaar in de Azure Stack Edge 2011-release. 
...
## <a name="known-issues-in-2011-release"></a>Bekende problemen in de 2011-release

De volgende tabel bevat een samen vatting van bekende problemen in de 2011-release.
