...
description: Meer informatie over het maken van een eenvoudige AD-en Azure AD-omgeving.
author: billmath
manager: daveba
...
![Diagram met een basisomgeving van Azure Active Directory.](media/tutorial-single-forest/diagram-2.png)
...
![Schermopname met de pagina Azure Active Directory in Azure Portal.](media/tutorial-single-forest/create-1.png)</br>
...
![Schermopname met het menu Overzicht met Gebruikers geselecteerd.](media/tutorial-single-forest/administrator-1.png)</br>
...
![Maken](media/tutorial-single-forest/administrator-2.png)</br>
...
Hierna volgt een optionele sectie met stappen voor het maken van een aanvullende server en/of forest.  Dit kan worden gebruikt in een aantal geavanceerdere zelf studies, zoals [pilot for Azure AD Connect, to Cloud Sync](tutorial-pilot-aadc-aadccp.md).
...
U hebt nu een omgeving die kan worden gebruikt voor bestaande zelf studies en voor het testen van aanvullende functies Cloud Sync.
