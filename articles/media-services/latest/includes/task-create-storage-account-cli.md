...
Met de volgende opdracht maakt u een Storage-account die wordt gekoppeld aan de Media Services-account. Vervang in het onderstaande script door uw eigen naam zonder naam en `storageaccountforams` een lengte van minder dan 24 tekens. `amsResourceGroup` moet overeenkomen met de waarde die u in de vorige stap hebt gegeven voor de resourcegroep.
