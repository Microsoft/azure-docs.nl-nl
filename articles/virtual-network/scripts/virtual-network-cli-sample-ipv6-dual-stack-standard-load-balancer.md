---
title: Voorbeeld van Azure CLI-script - IPv6-front-Standard Load Balancer
titlesuffix: Azure Virtual Network
description: Meer informatie over het configureren van IPv6-eindpunten in een voorbeeldscript voor een virtueel netwerk met behulp Standard Load Balancer.
...
ms.locfileid: "107776466"
---
# <a name="configure-ipv6-endpoints-in-virtual-network-script-sample-using-standard-load-balancerpreview"></a>Voorbeeld van IPv6-eindpunten in een virtueel netwerkscript configureren met Standard Load Balancer (preview)

In dit artikel wordt beschreven hoe u een toepassing met dubbele stack (IPv4 + IPv6) in Azure implementeert die een virtueel netwerk met dubbele stack met een dual stack-subnet, een Standard Load Balancer met dubbele front-endconfiguraties (IPv4 + IPv6), VM's met NIC's met een dubbele IP-configuratie, dubbele regels voor netwerkbeveiligingsgroep en dubbele openbare IP-adressen.
...
> [!NOTE]
> Het virtuele netwerk IPv6 voor Azure is beschikbaar in Azure Portal alleen-lezen voor deze preview-versie.
