...
1. Ga in de Azure-portal op de integratiepagina van de toepassing **Alibaba Cloud Service (op rollen gebaseerde eenmalige aanmelding)** naar de sectie **Beheren**, en selecteer **Eenmalige aanmelding**.
