...
De IP-adressen die door Application Insights Profiler worden gebruikt, zijn opgenomen in de code van de Azure Monitor-service. Zie [service Tags-documentatie](https://docs.microsoft.com/azure/virtual-network/service-tags-overview)voor meer informatie.
