...
| SamlAssertionDecryption |No | Het x509-certificaat (RSA key set). Een SAML-ID-provider gebruikt het open bare gedeelte van het certificaat om de bewering van het SAML-antwoord te versleutelen. Azure AD B2C gebruikt het privé gedeelte van het certificaat om de bewering te ontsleutelen. |
