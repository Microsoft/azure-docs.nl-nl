---
title: 'Quickstart: Een apparaat vanaf Azure IoT Hub (Android) | Microsoft Docs'
...
In deze sectie gebruikt u Azure Cloud Shell met de [IoT-extensie](/cli/azure/iot) voor het bewaken van de berichten die worden verzonden met het Android-apparaat.
