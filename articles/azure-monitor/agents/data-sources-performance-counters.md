...
Configureer prestatie meter items [in het menu Data van geavanceerde instellingen](../agents/agent-data-sources.md#configuring-data-sources) voor de werk ruimte log Analytics.
