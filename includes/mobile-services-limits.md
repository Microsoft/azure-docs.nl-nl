...
| Realtime chatten/<br/>websockets |Beperkt |350 per mobiele service |Onbeperkt |
| Offline synchronisaties |Beperkt |Inbegrepen |Inbegrepen |
| Geplande jobs |Beperkt |Inbegrepen |Inbegrepen |
| Azure SQL Database (vereist) <br/>Voor aanvullende capaciteit gelden standaardtarieven |20 MB inbegrepen |20 MB inbegrepen |20 MB inbegrepen |
...
Zie [Prijzen van Azure Mobile Services](https://azure.microsoft.com/pricing/details/mobile-services/) voor meer informatie over limieten en prijzen. 
