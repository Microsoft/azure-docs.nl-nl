---
title: Micro soft OPC Publisher telemetrie-indeling
description: Dit artikel bevat een overzicht van het bestand met configuratie-instellingen
author: jehona-m
ms.author: jemorina
...
ms.locfileid: "104787529"
---
# <a name="opc-publisher-telemetry-format"></a>OPC-indeling voor Publisher-telemetrie

OPC Publisher-versie 2,6 en hoger ondersteunen gestandaardiseerde OPC UA PubSub JSON-indeling zoals opgegeven in [deel 14 van de OPC UA-specificatie](https://opcfoundation.org/developer-tools/specifications-unified-architecture/part-14-pubsub/) en ziet er als volgt uit:
```
{
  "MessageId": "18",
  "MessageType": "ua-data",
...
Alle versies van OPC Publisher ondersteunen daarnaast een niet-gestandaardiseerde, eenvoudige JSON-telemetrie-indeling, die compatibel is met [Azure time series Insights](https://azure.microsoft.com/services/time-series-insights/) en ziet er als volgt uit:
```
[
   {
...
## <a name="opc-publisher-telemetry-configuration-file-format"></a>OPC-indeling van het telemetrie-configuratie bestand
```
