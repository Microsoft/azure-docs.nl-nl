---
title: 'Zelf studie: verbinding maken met een Azure SQL-Server met behulp van een persoonlijk Azure-eind punt-Portal'
...
ms.locfileid: "102554969"
---
# <a name="tutorial-connect-to-an-azure-sql-server-using-an-azure-private-endpoint---azure-portal"></a>Zelf studie: verbinding maken met een Azure SQL-Server met behulp van een persoonlijk Azure-eind punt-Azure Portal
...
9. Installeer [SQL Server Management Studio](/sql/ssms/download-sql-server-management-studio-ssms?preserve-view=true&view=sql-server-2017) op **myVM**.
