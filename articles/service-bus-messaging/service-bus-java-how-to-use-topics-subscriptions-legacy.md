...
> [!WARNING]
>  Deze quickstart maakt gebruik van het huidige, algemeen beschikbare (GA) Azure-servicebuspakket. Zie [Berichten verzenden en ontvangen met azure-messaging-servicebus](service-bus-java-how-to-use-topics-subscriptions.md) voor een quickstart waarbij gebruik wordt gemaakt van het nieuwe azure-messaging-servicebus-pakket in **preview**.
...
![Microsoft Azure-bibliotheken voor Java toevoegen aan uw Eclipse-project](media/service-bus-java-how-to-use-topics-subscriptions-legacy/eclipse-azure-libraries-java.png)
