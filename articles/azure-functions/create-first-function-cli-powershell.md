---
title: Een PowerShell-functie maken via de opdrachtregel - Azure Functions
description: Ontdek hoe u een PowerShell-functie maakt vanaf de opdrachtregel en vervolgens het lokale project publiceert op serverloze hosting in Azure Functions.
ms.date: 11/03/2020
ms.topic: quickstart
ms.custom:
...
ms.locfileid: "107831956"
---
# <a name="quickstart-create-a-powershell-function-in-azure-from-the-command-line"></a>Quickstart: Een PowerShell-functie maken in Azure vanaf de opdrachtregel
...
Er is ook een [Versie op basis van Visual Studio Code](create-first-function-vs-code-powershell.md) van dit artikel.
...
[Verbinding maken met een Azure Storage-wachtrij]: functions-add-output-binding-storage-queue-cli.md?pivots=programming-language-powershell
