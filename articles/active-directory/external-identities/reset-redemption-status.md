...
ms.locfileid: "106552254"
---
# <a name="reset-redemption-status-for-a-guest-user-preview"></a>De afstel status voor een gast gebruiker opnieuw instellen (preview-versie)
