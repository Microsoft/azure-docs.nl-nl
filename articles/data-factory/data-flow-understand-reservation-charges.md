...
De gereserveerde capaciteits korting voor de ADF-gegevens stroom wordt toegepast voor het uitvoeren van Integration Runtimes per uur. De reserve ring die u aanschaft, komt overeen met het reken gebruik dat wordt verzonden door de Integration runtime die wordt gebruikt. Voor gegevens stromen die niet het volledige uur uitvoeren, wordt de reserve ring automatisch toegepast op andere gegevens stromen die overeenkomen met de reserverings kenmerken. De korting kan worden toegepast op gegevens stromen die gelijktijdig worden uitgevoerd. Als u geen gegevens stromen hebt die worden uitgevoerd voor het volledige uur dat overeenkomt met de reserverings kenmerken, krijgt u niet het volledige voor deel van de reserverings korting voor dat uur.
