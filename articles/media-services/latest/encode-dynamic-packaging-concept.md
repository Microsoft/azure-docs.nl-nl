...
1. [Upload een invoerbestand](job-input-from-http-how-to.md), zoals een MP4-, QuickTime-/MOV-bestand of andere ondersteunde bestandsindeling. Dit bestand wordt ook wel het mezzanine- of bronbestand genoemd. Zie [indelingen die worden ondersteund door de Standard-encoder](encode-media-encoder-standard-formats-reference.md)voor een lijst met ondersteunde indelingen.
...
1. Publiceer de uitvoer-asset die de MP4-set met adaptieve bitsnelheid bevat. U publiceert door het maken van een [streaming-locator](stream-streaming-locators-concept.md).
...
Zie de lijst met [indelingen en codecs](encode-media-encoder-standard-formats-reference.md) voor Standard Encoder.
...
1. Maak een [livegebeurtenis](live-event-outputs-concept.md).
...
Zie [Overzicht van live streamen](stream-live-streaming-concept.md) voor informatie over live streamen in Media Services v3.
