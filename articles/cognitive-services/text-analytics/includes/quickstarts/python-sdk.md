...
Maak een nieuwe functie met de naam `analyze_batch_example()` waaraan de client via een argument wordt doorgegeven en die vervolgens de functie `begin_analyze_batch_actions()` aanroept. Het resultaat is een langdurige bewerking waarvan de resultaten worden gepolld.
