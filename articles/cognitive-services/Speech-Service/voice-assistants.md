...
* [Zelf studie: een toepassing voor aangepaste opdrachten maken met eenvoudige spraak opdrachten](./how-to-develop-custom-commands-application.md)
...
* [Aangepaste spraak](./custom-speech-overview.md)
