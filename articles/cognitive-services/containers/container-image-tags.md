...
| Land instelling voor v 2.10.0          | Notities                                    | Samenvatting                                                                    |
|-----------------------------|:-----------------------------------------|:--------------------------------------------------------------------------|
| `ar-ae`                     | Container installatie kopie met de `ar-AE` land instelling. | `sha256:f81f6c53e8ca9c3ae10c335ad45054cea571eca2f4ab32e44e13445936ce3f17` |
| `ar-bh`                     | Container installatie kopie met de `ar-BH` land instelling. | `sha256:da276dc1b481c002a9b3d2944e190af799175b5a2eabafab87153e22529bdab1` |
| `ar-eg`                     | Container installatie kopie met de `ar-EG` land instelling. | `sha256:c2ae166526cb0c5d481b537daa3accd379c4b1bf51fce6d85ac20591e7e0b4c0` |
| `ar-iq`                     | Container installatie kopie met de `ar-IQ` land instelling. | `sha256:7d4a6cb1d9d66f6bd62f90b82000ef811f8a3dd58b03641b6c51ad6f0f4fd4dc` |
| `ar-jo`                     | Container installatie kopie met de `ar-JO` land instelling. | `sha256:7489a0ed06fdf1da1d25e3211f5a66abe420babee148961a2ffe8cdbd82564a7` |
| `ar-kw`                     | Container installatie kopie met de `ar-KW` land instelling. | `sha256:f81f6c53e8ca9c3ae10c335ad45054cea571eca2f4ab32e44e13445936ce3f17` |
| `ar-lb`                     | Container installatie kopie met de `ar-LB` land instelling. | `sha256:478e4575073660e9153811f58e74815f62395ee2ebd868d448fbc3a5e16442be` |
| `ar-om`                     | Container installatie kopie met de `ar-OM` land instelling. | `sha256:025dcbd6a7d1912812b2556ffd7a16ad2158be6c3746e2822f2b97f460aa685b` |
| `ar-qa`                     | Container installatie kopie met de `ar-QA` land instelling. | `sha256:f81f6c53e8ca9c3ae10c335ad45054cea571eca2f4ab32e44e13445936ce3f17` |
| `ar-sa`                     | Container installatie kopie met de `ar-SA` land instelling. | `sha256:f81f6c53e8ca9c3ae10c335ad45054cea571eca2f4ab32e44e13445936ce3f17` |
| `ar-sy`                     | Container installatie kopie met de `ar-SY` land instelling. | `sha256:5af93722e70e445b3a4102bf621e6d5bb5854bcc99f60d4590e23fc24e50297e` |
| `bg-bg`                     | Container installatie kopie met de `bg-BG` land instelling. | `sha256:a9402f03b02150288d51e03ec97b8efb98ad6c444df3ab50a3b4ce1129d02d86` |
| `ca-es`                     | Container installatie kopie met de `ca-ES` land instelling. | `sha256:122df16df46a84a14b28e4ff406a047947fdc10a65b40482438beee55579f687` |
| `cs-cz`                     | Container installatie kopie met de `cs-CZ` land instelling. | `sha256:7b7d7ef798a0210b8c33a3a201ba149e1264cc7ac6ddaf986721d86e91e5e444` |
| `da-dk`                     | Container installatie kopie met de `da-DK` land instelling. | `sha256:ba8dd6564939eda7b81b1a4c13ad31672927528dd146698fce10c12d21f647a9` |
| `de-de`                     | Container installatie kopie met de `de-DE` land instelling. | `sha256:d0fa9bc409238ebdab0a15174b3169c99cbad42323087ea589bb7812a0550149` |
| `el-gr`                     | Container installatie kopie met de `el-GR` land instelling. | `sha256:4c4a115ae8daf53e344c1c4f838ebc68c3de2dae4d1f1aceb021425807d96ac0` |
| `en-au`                     | Container installatie kopie met de `en-AU` land instelling. | `sha256:f18c31f2bc9e655b93f71049b40dae2213c7417169f7a4e42f603d5891857b2a` |
| `en-ca`                     | Container installatie kopie met de `en-CA` land instelling. | `sha256:67f02cdb2285c2891aff8ff8d35ee20bad11f2d1cc1d67c461185466edefa5d6` |
| `en-gb`                     | Container installatie kopie met de `en-GB` land instelling. | `sha256:ed606155b5f9b6c6dd68c0c1f5e48a0735bc4a5ded872655c0ef7de2bf084312` |
| `en-hk`                     | Container installatie kopie met de `en-HK` land instelling. | `sha256:2fb6a64aaea5efdb2cac8bda2c7d437638fca93aa24268a45f2a395285e022df` |
| `en-ie`                     | Container installatie kopie met de `en-IE` land instelling. | `sha256:9ddb64e481cec6449dfc48091092247fa401fcd48ab1d955c5186565f903bd34` |
| `en-in`                     | Container installatie kopie met de `en-IN` land instelling. | `sha256:060a87ae817a82486966a4f10d1e872d30370ea58e297ca4c2018d0e034bfbe5` |
| `en-nz`                     | Container installatie kopie met de `en-NZ` land instelling. | `sha256:ece4299bd7f02fe4403b53320cf55bb2e3ab65da3d94bfea09124c14955a3de3` |
| `en-ph`                     | Container installatie kopie met de `en-PH` land instelling. | `sha256:6b47286a882122de8114942d426cbb8b4f1aded318032317b03a6b68237372e0` |
| `en-sg`                     | Container installatie kopie met de `en-SG` land instelling. | `sha256:41fa2caec6a732736f75b682e0410b89ba5e12307cd6e2652986a2676a5dd560` |
| `en-us`                     | Container installatie kopie met de `en-US` land instelling. | `sha256:80ae57602d8e66c6ed0366327a87c0ed5717b44c596b981a2b5be09c7f5a4c8a` |
| `en-za`                     | Container installatie kopie met de `en-ZA` land instelling. | `sha256:705c125e5105b6eed37d745e2092d55ca8b6ccff22f4eeac9c2df958f36c72e9` |
| `es-ar`                     | Container installatie kopie met de `es-AR` land instelling. | `sha256:67f794f16fdac457f0e0a84192e588611adb43777635b14706754c19fd90b130` |
| `es-bo`                     | Container installatie kopie met de `es-BO` land instelling. | `sha256:94f755e70043dbe011424a0f756970f1d01ec51cb95a469531e3a6b0aa84aed1` |
| `es-cl`                     | Container installatie kopie met de `es-CL` land instelling. | `sha256:c42eb56cbb48e0957f73793f83435c705ed0f857579acb020394025abdd760e2` |
| `es-co`                     | Container installatie kopie met de `es-CO` land instelling. | `sha256:7cfacb01fdb80bd1b5e68d16f9e2741237ae4ec1a41a9121aed1be2622fc9f3f` |
| `es-cr`                     | Container installatie kopie met de `es-CR` land instelling. | `sha256:7dbe5becdf4f3264764eb596d61781a2b2ee54bf9552bbb8f4db5e7fcf75d8f8` |
...
| `pl-pl`                     | Container installatie kopie met de `pl-PL` land instelling. | `sha256:9bf17aa5d4c577a440c770b6a63b66037a201cbea0202af4856257fde0548f0e` |
...
| `en-in-priyarus`                            | Container installatie kopie met de `en-IN` land instellingen en de `en-IN-PriyaRUS` stem.        | `sha256:43f5fffad77d3446bc08922df36e244115ecf6090e7c48c42281c2fa62d23b90` |
...
| `it-it-cosimo-apollo`                       | Container installatie kopie met de `it-IT` land instellingen en de `it-IT-Cosimo-Apollo` stem.   | `sha256:647b92d1591501ed032d67cf2cfd719e95c24ffb624143d301c2b6dc5eed7397` |
...
| `zh-cn-kangkang-apollo`                     | Container installatie kopie met de `zh-CN` land instellingen en de `zh-CN-Kangkang-Apollo` stem. | `sha256:cb638e72c8966204ab9142810b94cf4c2da54f3fd5917ae0e12a11d28a4253bb` |
...
Release opmerkingen voor `v1.4.0` :
* Voer een upgrade uit naar de nieuwste modellen. 
* De CPU-kosten en latentie zijn gereduceerd.
* Betere ondersteuning van prosody tuning with SSML tag (bijv. contour).

| Afbeeldings Tags                                  | Notities                                                                      |
|---------------------------------------------|:---------------------------------------------------------------------------|
| `latest`                                    | Container installatie kopie met de `en-US` land instellingen en de `en-US-AriaNeural` stem.      |
| `1.4.0-amd64-<locale-and-voice>`    | Vervang door `<locale>` een van de beschik bare land instellingen, zoals hieronder wordt weer gegeven. Bijvoorbeeld `1.4.0-amd64-en-us-arianeural`. |


| v 1.4.0 land instellingen en stemmen           | Notities                                                                      |
|-------------------------------------|:---------------------------------------------------------------------------|
...
| `en-us-jennyneural`                 | Container installatie kopie met de `en-US` land instellingen en de `en-US-JennyNeural` stem.     |
...
| `hi-in-swaracpuneural`              | Container installatie kopie met de `hi-IN` land instellingen en de `hi-IN-Swaraneural` stem.     |
...
| `zh-cn-xiaoyouneural`               | Container installatie kopie met de `zh-CN` land instellingen en de `zh-CN-XiaoYouNeural` stem.   |
| `zh-cn-yunyangneural`               | Container installatie kopie met de `zh-CN` land instellingen en de `zh-CN-YunYangNeural` stem.   |
| `zh-cn-yunyeneural`                 | Container installatie kopie met de `zh-CN` land instellingen en de `zh-CN-YunYeNeural` stem.     |
...
|---------------------------------------------|:---------------------------------------------------------------------------|
| `latest`                                    | Container installatie kopie met de `en-US` land instellingen en de `en-US-AriaNeural` stem.      |
| `1.3.0-amd64-<locale-and-voice>-preview`    | Vervang door `<locale>` een van de beschik bare land instellingen, zoals hieronder wordt weer gegeven. Bijvoorbeeld `1.3.0-amd64-en-us-arianeural-preview`. |
...
De [Text Analytics voor de status][ta-he] container installatie kopie vindt u in het `mcr.microsoft.com` container register Syndicate. Deze bevindt zich in de `azure-cognitive-services/textanalytics/` opslag plaats en heet `healthcare` . De volledig gekwalificeerde naam van de container installatie kopie is `mcr.microsoft.com/azure-cognitive-services/textanalytics/healthcare`

Voor deze container installatie kopie zijn de volgende tags beschikbaar. U kunt ook een volledige lijst met [Tags vinden op het MCR](https://mcr.microsoft.com/v2/azure-cognitive-services/textanalytics/healthcare/tags/list).


Release opmerkingen voor `3.0.015490002-onprem-amd64` :

* nieuw model-versie `2021-03-01`
