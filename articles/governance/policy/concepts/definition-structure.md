...
- `allowedValues`: (Optioneel) biedt een matrix van waarden die door de para meter worden geaccepteerd tijdens de toewijzing. Toegestane waarden vergelijkingen zijn hoofdletter gevoelig. 
