...
MSAL.NET ondersteunt een [token cache](/dotnet/api/microsoft.identity.client.tokencache). De cache sleutel voor tokens is gebaseerd op de claims die zijn geretourneerd door de ID-provider (IdP).
