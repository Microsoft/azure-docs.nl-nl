...
**Hulp**: gebruik een privileged Access-werk station (Paw) met Azure AD multi-factor Authentication (MFA) waarmee u uw Azure data Box orders kunt aanmelden en configureren.
