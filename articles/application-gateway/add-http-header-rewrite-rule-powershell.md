...
In dit voor beeld wordt de set herschrijven direct gekoppeld aan een basis routerings regel. In het geval van een op pad gebaseerde routerings regel, wordt de koppeling niet standaard ingeschakeld. De herschrijfset kan worden ingeschakeld via het controleren van de paden waarop deze moet worden toegepast via de portal of door het opgeven van een URL-pad voor het configureren van de RewriteRuleSet voor elke pad optie.  
