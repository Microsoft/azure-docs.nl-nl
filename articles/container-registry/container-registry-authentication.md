...
| [Beheerde identiteit voor Azure-resources](container-registry-authentication-managed-identity.md)  | `docker login`<br/><br/> `az acr login` in Azure CLI                                       | Pushen zonder toezicht vanuit Azure CI/CD-pijplijn<br/><br/> Pull zonder toezicht naar Azure-services<br/><br/>   | Yes                              | Alleen gebruiken in geselecteerde Azure-services die [beheerde identiteiten voor Azure-resources ondersteunen](../active-directory/managed-identities-azure-resources/services-support-managed-identities.md#azure-services-that-support-managed-identities-for-azure-resources)              |
