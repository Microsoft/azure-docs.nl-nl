...
Met Azure Communication Services kunt u SMS-tekst berichten verzenden en ontvangen met behulp van de SMS-Sdk's voor communicatie Services. Deze Sdk's kunnen worden gebruikt ter ondersteuning van klanten service scenario's, afspraak herinneringen, twee ledige verificatie en andere realtime communicatie behoeften. Met SMS-communicatie Services kunt u op een betrouw bare manier berichten verzenden terwijl u de metrische gegevens voor de levering en het antwoord weergeeft.
...
- **Bulk berichten** die worden ondersteund om het verzenden van berichten naar meerdere ontvangers tegelijk mogelijk te maken.
...
- **Analyse** om uw SMS-gebruiks patronen bij te houden.
