...
Op dit moment worden alle tekst bestanden in de hoofdmap van de site **wwwroot** met de volgende extensies ondersteund:
- *. json
- *. XML
- *. ini
- *. yml
...
## <a name="enable-change-analysis-at-scale-for-web-app-in-guest-file-and-environment-variable-changes"></a>Wijzigings analyse op schaal inschakelen voor web-app in-gast bestand en omgevings variabele wijzigingen
