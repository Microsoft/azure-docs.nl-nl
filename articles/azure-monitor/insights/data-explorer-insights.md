---
title: Azure Data Explorer cluster bewaken met Azure Monitor voor Azure Data Explorer (preview) | Microsoft Docs
...
ms.locfileid: "97901732"
---
# <a name="monitoring-your-azure-data-explorer-cluster-with-azure-monitor-for-azure-data-explorer-preview"></a>Uw Azure Data Explorer-cluster bewaken met Azure Monitor voor Azure Data Explorer (preview-versie)
...
![Scherm afbeelding van overzichts ervaring met meerdere grafieken](./media/data-explorer-insights/insights-hub.png)
...
![Scherm afbeelding van het tabblad Query prestaties](./media/data-explorer-insights/query-performance.png)
...
[![Scherm afbeelding van het tabblad opname prestaties](./media/data-explorer-insights/ingestion-performance.png)](./media/data-explorer-insights/ingestion-performance.png#lightbox)
...
![Scherm afbeelding van een blauwe knop waarmee de tekst ' logboeken voor bewaking inschakelen ' wordt weer gegeven](./media/data-explorer-insights/enable-logs.png)
...
[![Scherm opname van de weer gave van een Azure Data Explorer-cluster resource](./media/data-explorer-insights/overview.png)](./media/data-explorer-insights/overview.png#lightbox)
...
[![Scherm opname van fouten weergave](./media/data-explorer-insights/key-metrics.png)](./media/data-explorer-insights/key-metrics.png#lightbox)
...
[![Scherm afbeelding van een bewerkings weergave met ring grafieken van de bovenste toepassing op basis van de opdracht en het aantal query's, Top-principals op opdrachten en query's en de belangrijkste opdrachten op opdracht typen](./media/data-explorer-insights/usage.png)](./media/data-explorer-insights/usage.png#lightbox)

[![Scherm afbeelding van een bewerkings weergave met lijn diagrammen van het aantal query's per toepassing, totaal geheugen per toepassing en totale CPU per toepassing](./media/data-explorer-insights/usage-2.png)](./media/data-explorer-insights/usage-2.png#lightbox)
...
[![Scherm opname van cache Details](./media/data-explorer-insights/cache-tab.png)](./media/data-explorer-insights/cache-tab.png#lightbox)
...
![Scherm afbeelding van het pictogram pincode geselecteerd](./media/data-explorer-insights/pin.png)
...
![Scherm afbeelding van de knop aanpassen](./media/data-explorer-insights/customize.png)
...
![Scherm opname van de werkmap galerie](./media/data-explorer-insights/gallery.png)
...
### <a name="i-have-already-enabled-logs-for-my-azure-data-explorer-cluster-why-am-i-still-unable-to-see-my-data-under-commands-and-queries"></a>Ik heb logboeken al ingeschakeld voor mijn Azure Data Explorer-cluster, waarom kan ik mijn gegevens nog steeds niet zien onder opdrachten en Query's
