...
ms.locfileid: "97005576"
---
# <a name="upload-files-to-a-web-app-using-ftp"></a>Bestanden uploaden naar een web-app met FTP

Met dit voorbeeldscript wordt er in App Service een web-app met bijbehorende resources gemaakt. Daarna wordt de code van de web-app geïmplementeerd met FTP (via [WebClient.UploadFile()](/dotnet/api/system.net.webclient.uploadfile)).
