...
Tijdens het werken met de scenario's in dit voorbeeld kunt u het [referentiemateriaal bij de Azure Cosmos DB SDK voor Python-API](/python/api/overview/azure/cosmosdb) raadplegen.
...
* [Azure Storage account](../storage/common/storage-account-create.md) of [Azure Cosmos DB account](https://azure.microsoft.com/try/cosmosdb/).
...
## <a name="query-for-an-entity-without-partition-and-row-keys"></a>Een query uitvoeren voor een entiteit zonder partitie-en rijgegevens

U kunt ook een query uitvoeren voor entiteiten in een tabel zonder de partitie-en rijgegevens te gebruiken. Gebruik de `table_service.query_entities` methode zonder de para meters ' filter ' en ' Select ', zoals in het volgende voor beeld wordt weer gegeven:
...
* [Referentiemateriaal voor Azure Cosmos DB SDK voor Python-API](/python/api/overview/azure/cosmosdb)
