...
**Nils. Wie zijn de doel klanten?**

A. Doel klanten zijn ondernemingen die verbinding maken met micro soft Cloud via internet als Trans Port.

**Nils. Kunnen klanten zich registreren voor een peering-service met meerdere providers?** 
...
**Nils. Kunnen klanten een unieke ISP selecteren voor hun sites per geografische regio?**
...
**Nils. Hoe wijkt de peering-service af van de normale Internet toegang?**
...
**Nils. Hoe wijkt de peering-service af van ExpressRoute?**
