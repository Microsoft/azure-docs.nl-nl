...
ms.locfileid: "102444452"
---
# <a name="version-31-preview"></a>[Versie 3.1: preview](#tab/version-3-1)

[Naslagdocumentatie voor v3.1](https://westus2.dev.cognitive.microsoft.com/docs/services/TextAnalytics-v3-1-preview-3/) (Engelstalig)
...
> [!NOTE]
> Het onderstaande voorbeeld bevat een aanvraag voor de functie Meninganalyse van Sentimentanalyse waarbij parameter `opinionMining=true` wordt gebruikt. Dit biedt gedetailleerde informatie over de meningen over bepaalde aspecten (zoals de kenmerken van producten of diensten) in de tekst.
