...
description: Een lijst met Azure Policy ingebouwde beleids definities voor Data Factory. Deze ingebouwde beleidsdefinities bieden algemene benaderingen voor het beheren van uw Azure-resources.
ms.author: lle
author: lrtoyou1223
...
ms.locfileid: "105038041"
---
# <a name="azure-policy-built-in-definitions-for-data-factory-preview"></a>Azure Policy ingebouwde definities voor Data Factory (preview-versie)
[!INCLUDE[appliesto-adf-xxx-md](includes/appliesto-adf-xxx-md.md)]

Deze pagina bevat een index van [Azure Policy](../governance/policy/overview.md) ingebouwde beleids definities voor Data Factory. Zie [Ingebouwde Azure Policy-definities](../governance/policy/samples/built-in-policies.md) voor aanvullende ingebouwde modules voor Azure Policy voor andere services.
