...
| **HANA-versies**          | Dit SDC op HANA 1. x, MDC op HANA 2. x <= SPS04 Rev 53, SPS05 (nog moeten worden gevalideerd voor scenario's waarbij versleuteling is ingeschakeld)      |                                                            |
