...
Ja. Deze optie is momenteel alleen beschikbaar via PowerShell. De virtuele WAN-Portal vereist dat de hubs zich in dezelfde resource groep bevinden als de virtuele WAN-resource zelf.
