---
title: 'Quickstart: cURL gebruiken om de Text Analytics REST API aan te roepen'
titleSuffix: Azure Cognitive Services
description: In deze quickstart leert u hoe u snel aan de slag kunt met behulp van de API voor Text Analytics in Azure Cognitive Services.
...
ms.locfileid: "107765076"
---
# <a name="version-31-preview"></a>[Versie 3.1: preview](#tab/version-3-1)

[Naslagdocumentatie voor v3.1](https://westus2.dev.cognitive.microsoft.com/docs/services/TextAnalytics-v3-1-preview-4/) (Engelstalig)

# <a name="version-30"></a>[Versie 3.0](#tab/version-3)

[Naslagdocumentatie voor v3](https://westus.dev.cognitive.microsoft.com/docs/services/TextAnalytics-v3-0) (Engelstalig) 

---

## <a name="prerequisites"></a>Vereisten

* De huidige versie van [cURL](https://curl.haxx.se/).
...
> * U kunt taalspecifieke voorbeelden vinden op [GitHub](https://github.com/Azure-Samples/cognitive-services-quickstart-code) (Engelstalig).
> * Ga naar Azure Portal en zoek de sleutel en het eindpunt voor de Text Analytics-resource die u zojuist hebt gemaakt. U vindt deze op de pagina **Sleutel en eindpunt** van de resource, onder **Resourcebeheer**. Vervang de tekenreeksen in de onderstaande code door uw sleutel en eindpunt.
U hebt de volgende informatie nodig om de API voor Text Analytics aan te roepen:
...
> [!NOTE]
> Het onderstaande voorbeeld bevat een aanvraag voor de functie Meninganalyse van Sentimentanalyse met behulp van de parameter , die gedetailleerde informatie biedt over evaluaties (bijvoeglijke naamwoorden) met betrekking tot doelen (zelfstandige naamwoorden) in de `opinionMining=true` tekst.
...
### <a name="detecting-personally-identifying-information"></a>Detecteren van persoonlijke gegevens
