...
ms.locfileid: "97703960"
---
  U kunt een van deze quickstarts gebruiken om een database te maken en vervolgens te configureren:

  | Bewerking | SQL Database | SQL Managed Instance | SQL Server op virtuele Azure-machine | Azure Synapse Analytics |
  |:--- |:--- |:---|:---|:---|
  | Maken| [Portal](../database/single-database-create-quickstart.md) | [Portal](../managed-instance/instance-create-quickstart.md) | [Portal](../virtual-machines/windows/sql-vm-create-portal-quickstart.md) | [Portal](../../synapse-analytics/quickstart-create-workspace.md) |
  ...
  || | | [Implementatiesjabloon](../virtual-machines/windows/create-sql-vm-resource-manager-template.md) | [Implementatiesjabloon](../../synapse-analytics/quickstart-deployment-template-workspaces.md) | 
  | Configureren | [IP-firewallregel op serverniveau](../database/firewall-create-server-level-portal-quickstart.md)| [Connectiviteit vanaf een VM](../managed-instance/connect-vm-instance-configure.md)| |
