...
description: Meer informatie over ondertekende client verklaringen ondersteuning voor vertrouwelijke client toepassingen in de micro soft Authentication Library voor .NET (MSAL.NET).
