...
Gebruik de azure [CLI-opdracht az keyvault secret set](/cli/azure/keyvault/secret#az_keyvault_secret_set) hieronder om een geheim te maken in Key Vault met de naam **ExamplePassword** waarin de waarde **hVFkk965BuUv wordt opgeslagen:**
