...
Het is raadzaam dat u bekend raakt met aangepaste trans formaties door [te lezen hoe u codeert met een aangepaste transform-rest](transform-custom-preset-rest-how-to.md).
...
[Miniaturen genereren met behulp van .NET](transform-generate-thumbnails-dotnet-how-to.md)