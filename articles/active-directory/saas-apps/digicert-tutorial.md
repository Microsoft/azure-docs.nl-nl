...
* U kunt Microsoft Mijn apps gebruiken. Wanneer u op de tegel DigiCert in de mijn apps klikt, moet u automatisch worden aangemeld bij de DigiCert waarvoor u de SSO hebt ingesteld. Zie [Introduction to My Apps](../user-help/my-apps-portal-end-user-access.md) (Inleiding tot Mijn apps) voor meer informatie over Mijn apps.
