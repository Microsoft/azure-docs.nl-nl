...
ms.locfileid: "98735823"
---
# <a name="supported-devices"></a>Ondersteunde apparaten

De [Azure Portal](https://portal.azure.com) is een webconsole en wordt uitgevoerd in de browser van alle moderne Bureau bladen en Tablet-apparaten. Als u de portal wilt gebruiken, moet Java script zijn ingeschakeld in uw browser. We raden u aan AD-blok keringen niet te gebruiken in uw browser omdat deze problemen kunnen veroorzaken met bepaalde portal functies.
