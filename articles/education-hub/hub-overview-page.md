---
title: Uw academische subsidie beheren in de Azure Education Hub
description: Hierin wordt beschreven hoe u de details van uw academische subsidie weergeeft en bijwerkt op de overzichts pagina van Azure Education Hub.
author: v-shmck
ms.author: rymend
ms.topic: how-to
...
1. **Actie vereist** bevat een lijst met acties die u moet volt ooien, zoals het accepteren van een uitnodiging voor een lab.
1. **Software** vermeldt gratis software die kan worden gedownload als een docent.
1. **Leer** koppelingen naar gratis Azure-leer trajecten die beschikbaar zijn via Microsoft learn.
1. **Quick** start-sjablonen bevatten Azure-sjablonen waarmee u de implementatie voor algemene taken kunt versnellen en vereenvoudigen.

## <a name="next-steps"></a>Volgende stappen

> [!div class="nextstepaction"]
> [Een cursus instellen, tegoed toewijzen en studenten uitnodigen](create-assignment-allocate-credit.md)
