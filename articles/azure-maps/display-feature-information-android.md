...
De Azure Maps Android SDK biedt een `Popup` klasse waarmee u eenvoudig ui-aantekeningen elementen kunt maken die zijn gekoppeld aan een positie op de kaart. Voor pop-ups moet u een weer gave met een relatieve indeling door geven in de `content` optie van de pop-up. Hier volgt een eenvoudige indelings voorbeeld waarin donkere tekst boven op een achtergrond wordt weer gegeven.
