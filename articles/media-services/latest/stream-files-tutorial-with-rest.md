...
Als u streaming wilt inschakelen, moet u eerst het [streaming-eindpunt](./stream-streaming-endpoint-concept.md) starten op de locatie van waaruit u de video wilt streamen.
