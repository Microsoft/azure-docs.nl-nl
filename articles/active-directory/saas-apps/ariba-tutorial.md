...
ms.locfileid: "101647244"
---
# <a name="tutorial-azure-active-directory-integration-with-ariba"></a>Zelfstudie: Azure Active Directory-integratie met Ariba

In deze zelf studie leert u hoe u Ariba integreert met Azure Active Directory (Azure AD). Wanneer u Ariba integreert met Azure AD, kunt u het volgende doen:

* Controle in azure AD die toegang heeft tot Ariba.
* Zorg ervoor dat uw gebruikers automatisch worden aangemeld bij Ariba met hun Azure AD-accounts.
...
* Ariba-abonnement dat is ingeschakeld voor eenmalige aanmelding (SSO).
...
## <a name="add-ariba-from-the-gallery"></a>Ariba toevoegen vanuit de galerie
...
## <a name="configure-and-test-azure-ad-sso-for-ariba"></a>Azure AD SSO voor Ariba configureren en testen

Azure AD SSO met Ariba configureren en testen met behulp van een test gebruiker met de naam **B. Simon**. Voor het werken met SSO moet u een koppelings relatie tot stand brengen tussen een Azure AD-gebruiker en de bijbehorende gebruiker in Ariba.

Voer de volgende stappen uit om Azure AD SSO te configureren en te testen met Ariba:

1. **[Eenmalige aanmelding van Azure AD configureren](#configure-azure-ad-sso)** : zodat uw gebruikers deze functie kunnen gebruiken.
    1. **[Een Azure AD-testgebruiker maken](#create-an-azure-ad-test-user)** : om eenmalige aanmelding van Azure AD te testen met B.Simon.
    1. **[De Azure AD-testgebruiker toewijzen](#assign-the-azure-ad-test-user)** zodat B.Simon eenmalige aanmelding van Azure AD kan gebruiken.
1. **[ARIBA SSO configureren](#configure-ariba-sso)** : voor het configureren van de instellingen voor eenmalige aanmelding aan de kant van de toepassing.
    1. **[Maak een Ariba-test gebruiker](#create-ariba-test-user)** -om een equivalent van B. Simon in Ariba te hebben dat is gekoppeld aan de Azure AD-representatie van de gebruiker.
...
1. Zoek in het Azure Portal op de pagina Toepassings integratie van **Ariba** de sectie **beheren** en selecteer **eenmalige aanmelding**.
...
* Klik in Azure Portal op **Deze toepassing testen**. Dit wordt omgeleid naar de Ariba-aanmeldings-URL waar u de aanmeldings stroom kunt initiëren. 

* Ga rechtstreeks naar de URL voor Ariba-aanmelding en start de aanmeldings stroom vanaf daar.

* U kunt Microsoft Mijn apps gebruiken. Wanneer u op de tegel Ariba in de mijn apps klikt, wordt dit omgeleid naar de Ariba-aanmeldings-URL. Zie [Introduction to My Apps](../user-help/my-apps-portal-end-user-access.md) (Inleiding tot Mijn apps) voor meer informatie over Mijn apps.

## <a name="next-steps"></a>Volgende stappen

Nadat u Ariba hebt geconfigureerd, kunt u sessie beheer afdwingen, waardoor exfiltration en infiltratie van de gevoelige gegevens van uw organisatie in real-time worden beschermd. Sessiebeheer is een uitbreiding van voorwaardelijke toegang. [Meer informatie over het afdwingen van sessiebeheer met Microsoft Cloud App Security](/cloud-app-security/proxy-deployment-any-app).