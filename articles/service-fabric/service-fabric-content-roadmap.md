...
* Status query's (via [Power shell](/powershell/module/ServiceFabric/New-ServiceFabricService), [cli](service-fabric-sfctl.md), de [C# FabricClient Api's](/dotnet/api/system.fabric.fabricclient.healthclient) en [Java FabricClient-api's](/java/api/system.fabric)of [rest-api's](/rest/api/servicefabric)).
