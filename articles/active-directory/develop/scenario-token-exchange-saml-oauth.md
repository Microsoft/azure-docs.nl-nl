...
Dit artikel bevat een overzicht van een veelvoorkomend scenario waarbij een app SAML implementeert, maar aanroept de Graph API, die gebruikmaakt van OIDC/OAuth. Basis richtlijnen worden gegeven voor personen die met dit scenario werken.
