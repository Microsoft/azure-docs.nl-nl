---
title: 'Zelfstudie: Een bestaand aangepast domein aan een Azure Spring Cloud'
...
ms.locfileid: "107567992"
---
# <a name="tutorial-map-an-existing-custom-domain-to-azure-spring-cloud"></a>Zelfstudie: Een bestaand aangepast domein aan een Azure Spring Cloud
...
## <a name="keyvault-private-link-considerations"></a>Keyvault Private Link overwegingen

De Azure Spring Cloud voor beheer-IP's maken nog geen deel uit van de vertrouwde Azure Microsoft-services. Daarom moet u de volgende AZURE SPRING CLOUD toevoegen aan Azure Key Vault Firewall als u wilt toestaan dat gebruikers certificaten laden van een Key Vault beveiligd met privé-eindpuntverbindingen:
