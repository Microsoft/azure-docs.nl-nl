...
- Een [Log Analytics-werkruimte](../../azure-monitor/platform/data-platform-logs.md). Zie [De implementatie van uw Azure Monitor-logboeken ontwerpen](../../azure-monitor/platform/design-logs-deployment.md)voor meer informatie over Log Analytics-werkruimten.
