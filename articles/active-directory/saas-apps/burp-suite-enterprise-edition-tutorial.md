...
* U kunt Microsoft Mijn apps gebruiken. Wanneer u in Mijn apps op de tegel Burp Suite Enterprise Edition klikt, wordt u automatisch aangemeld bij de Burp Suite Enterprise Edition-instantie waarvoor u eenmalige aanmelding hebt ingesteld. Zie [Introduction to My Apps](../user-help/my-apps-portal-end-user-access.md) (Inleiding tot Mijn apps) voor meer informatie over Mijn apps.
