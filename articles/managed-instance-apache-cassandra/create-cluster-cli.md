...
1. Pas enkele speciale machtigingen toe op de Virtual Network en het subnet, die vereist zijn voor het beheerde exemplaar. Hiervoor moet u de resource-ID voor uw bestaande Virtual Network ophalen. Voer de volgende opdracht uit en kopieer de waarde van `Resource ID` para meter:
