...
* Voer de stappen uit in het [Active Directory B2C aan de slag met aangepaste beleids regels](tutorial-create-user-flows.md?pivots=b2c-custom-policy).
