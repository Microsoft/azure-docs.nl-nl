...
Raadpleeg de [Active Directory-marketplace](https://azuremarketplace.microsoft.com/marketplace/apps/category/azure-active-directory-apps) voor een lijst met alle SaaS-apps die vooraf zijn geïntegreerd in Azure Active Directory.

Gebruik de [netwerkportal van de toepassing](../develop/v2-howto-app-gallery-listing.md) om een [SCIM](../app-provisioning/use-scim-to-provision-users-and-groups.md)-toepassing aan te vragen voor de galerie voor automatische inrichting, of een SAML-/ODIC-toepassing die aan de galerie kan worden toegevoegd voor SSO.
...
| ![logo-Google Cloud Platform](./media/tutorial-list/active-directory-saas-google-apps-tutorial.png)| [Google Cloud Platform](google-apps-tutorial.md)| [Google Cloud Platform - Gebruikers inrichten](g-suite-provisioning-tutorial.md) |
...
| ![logo-AWS single Sign-On](./media/tutorial-list/active-directory-saas-aws-single-sign-on-tutorial.png)| [AWS eenmalige aanmelding](aws-single-sign-on-tutorial.md)|
...
| ![logo-EasySSO voor Bamboo](./media/tutorial-list/active-directory-saas-easy-sso-for-bamboo-tutorial.png)| [EasySSO for Bamboo](easysso-for-bamboo-tutorial.md)|
| ![logo-EasySSO voor BitBucket](./media/tutorial-list/active-directory-saas-easy-sso-for-bitbucket-tutorial.png)| [EasySSO voor BitBucket](easysso-for-bitbucket-tutorial.md)|
| ![logo-EasySSO voor Confluence](./media/tutorial-list/active-directory-saas-easy-sso-for-confluence-tutorial.png)| [EasySSO voor Confluence](easysso-for-confluence-tutorial.md)|
...
| ![logo-Zoom](./media/tutorial-list/active-directory-saas-zoom-tutorial.png)| [In- en uitzoomen](zoom-tutorial.md)|
