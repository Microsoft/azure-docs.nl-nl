...
- Het [streaming-eind punt](stream-streaming-endpoint-concept.md) `hostname` en de streaming-URL blijven hetzelfde, ongeacht of u CDN inschakelt.
...
* Zorg ervoor dat u het [streaming-eind punt document (origin)](stream-streaming-endpoint-concept.md) bekijkt.
