...
| DT-dataschema | Deze waarde wordt ingesteld door IoT hub op apparaat-naar-Cloud-berichten. Het bevat de apparaat model-ID die is ingesteld in de apparaat-verbinding. | No | N.v.t. |
| DT-onderwerp | De naam van het onderdeel dat de apparaat-naar-Cloud-berichten verzendt. | Yes | N.v.t. |
