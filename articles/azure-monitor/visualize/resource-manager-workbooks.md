...
Workbooks kunnen complex zijn, dus een veelgebruikte strategie is om de werkmap te maken in Azure Portal en vervolgens een Resource Manager-sjabloon te genereren. Zie [Azure Resource Manager-sjabloon voor het implementeren van werkmappen](../visualize/workbooks-automate.md) voor meer informatie over deze methode.
...
* [Meer informatie over actiegroepen](../visualize/workbooks-overview.md).
