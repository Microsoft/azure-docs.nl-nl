...
![Periode](media/alerts-troubleshoot-log/LogAlertTimePeriod.png)
...
![Waarschuwingen onderdrukken](media/alerts-troubleshoot-log/LogAlertSuppress.png)
...
![De query die moet worden uitgevoerd](media/alerts-troubleshoot-log/LogAlertPreview.png)
...
- De [query is mislukt](https://dev.loganalytics.io/documentation/Using-the-API/Errors) omdat:
    ...
    - [Aangepaste logboeken tabellen](../agents/data-sources-custom-logs.md) zijn nog niet gemaakt, omdat de gegevens stroom niet is gestart.
