...
|---|---|
| [az sql db copy](/cli/azure/sql/db#az_sql_db_copy) | Hiermee maakt u een kopie van een database die gebruikmaakt van de momentopname op de huidige tijd. |
