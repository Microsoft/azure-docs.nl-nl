...
5. Voer onder de sectie **Referenties voor beheerder** `https://api.spaceiq.com/scim` in bij **Tenant-URL**. Voer de waarde van het **SCIM-verificatietoken** in die eerder in **Token voor geheim** is opgehaald. Klik op **Verbinding testen** om te controleren of Azure AD verbinding kan maken met SpaceIQ. Als de verbinding mislukt, moet u controleren of uw SpaceIQ-account beheerdersmachtigingen heeft. Probeer het daarna opnieuw.
