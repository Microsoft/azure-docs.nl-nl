...
Een andere oorzaak van deze `InvalidNetworkConfigurationErrorCode` fout code is het gebruik van de gedeprecieerde para meter `EnableVmProtection` in Power shell of een Azure-Runbook.

### <a name="resolution"></a>Oplossing

Gebruik de geldige para meters voor `Get-AzVirtualNetwork` zoals beschreven in de [AZ Power shell SDK](https://docs.microsoft.com/powershell/module/az.network/get-azvirtualnetwork?view=azps-5.3.0&viewFallbackFrom=azps-4.2.0)
