---
title: DRM-versleuteling en licentie levering Media Services
...
U kunt Azure Media Services gebruiken voor het leveren van streams die zijn versleuteld met licenties van Microsoft PlayReady, Google Widevine of Apple FairPlay. Zie [Inhoudsbeveiliging met dynamische versleuteling](drm-content-protection-concept.md) voor een gedetailleerde uitleg.
...
![AMS met DRM beveiligde video in Azure Media Player](./media/drm-protect-with-drm-tutorial/ams_player.png)
...
* Lees het artikel [Content protection overview](drm-content-protection-concept.md) (Overzicht inhoudsbeveiliging).
* Lees [Inhoudsbeveiligingssysteem met multi-DRM met toegangsbeheer ontwerpen](architecture-design-multi-drm-system.md).
* Installeer Visual Studio Code of Visual Studio.
* Maak een nieuw Media Services-account zoals beschreven in deze [snelstart](./account-create-how-to.md).
...
Zoals eerder vermeld, is het **transformatie**-object het recept en is de [taak](transform-jobs-concept.md) de werkelijke aanvraag bij Media Services om deze **transformatie** toe te passen op een bepaalde invoervideo of audio-inhoud. De **taak** bevat informatie zoals de locatie van de invoervideo en de locatie voor de uitvoer.
...
* Configuratie
    ...
    De licenties van [PlayReady](drm-playready-license-template-concept.md) en [Widevine](drm-widevine-license-template-concept.md) zijn geconfigureerd om te kunnen worden geleverd door de Media Services-service voor het leveren van licenties. Hoewel met deze voorbeeld-app de licentie van [FairPlay](drm-fairplay-license-overview.md) niet wordt geconfigureerd, bevat deze een methode waarmee u FairPlay kunt configureren. U kunt het configureren van FairPlay als een andere optie toevoegen.
...
1. Een [streaminglocator](stream-streaming-locators-concept.md) maken.
...
![Beschermen met drm](./media/drm-protect-with-drm-tutorial/playready_encrypted_url.png)
...
> [Beveiligen met AES-128](drm-playready-license-template-concept.md)
