...
2. Selecteer **apparaat opnieuw instellen**.
    ...
    ![Apparaat opnieuw instellen](media/azure-stack-edge-device-reset/device-reset-1.png)

3. Als u om bevestiging wordt gevraagd, controleert u de waarschuwing en selecteert u **Ja** om door te gaan.

    ![Opnieuw instellen bevestigen](media/azure-stack-edge-device-reset/device-reset-2.png)  
