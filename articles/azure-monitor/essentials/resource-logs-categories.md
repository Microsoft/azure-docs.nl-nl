...
## <a name="microsoftautonomousdevelopmentplatformaccounts"></a>Micro soft. AutonomousDevelopmentPlatform/accounts

|Categorie|Weergave naam categorie|Te exporteren kosten|
|---|---|---|
|Controleren|Controleren|Yes|
|Operationeel|Operationeel|Yes|
...
|Categorie|Weergave naam categorie|Te exporteren kosten|
|---|---|---|
|AuthOperational|Operationele verificatie logboeken|Yes|
...
|SandboxActivityRuns|Logboek voor uitvoering van sandbox-activiteit|Yes|
|SandboxPipelineRuns|Logboek voor uitvoering van sandbox-pipeline|Yes|
...
|Categorie|Weergave naam categorie|Te exporteren kosten|
|---|---|---|
|PostgreSQLLogs|PostgreSQL-server logboeken|Yes|
...
|Categorie|Weergave naam categorie|Te exporteren kosten|
|---|---|---|
|AllLogs|Logboeken van de Azure Web PubSub-service.|Yes|
...
|IntegrationActivityRuns|Uitvoering van integratie activiteit|Yes|
|IntegrationPipelineRuns|Integratie pijplijn uitvoeringen|Yes|
|IntegrationTriggerRuns|Integratie triggers worden uitgevoerd|Yes|
|SQLSecurityAuditEvents|SQL-beveiligings controle gebeurtenis|No|
