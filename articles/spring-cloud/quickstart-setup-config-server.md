...
> [!TIP]
> Raadpleeg onze [zelfstudie over het instellen van verificatie](./spring-cloud-howto-config-server.md) als u een privéopslagplaats gebruikt voor de configuratieserver.
