...
In dit artikel hebt u meer geleerd over het verbinden van uw Azure Spring Cloud-toepassing met Azure Cache voor Redis. Zie [Verbinden met een Azure Database for MySQL-exemplaar](spring-cloud-howto-bind-mysql.md) voor meer informatie over bindingsservices voor uw toepassing.
