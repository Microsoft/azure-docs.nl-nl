...
ms.locfileid: "107377008"
---
# <a name="get-all-application-proxy-apps-that-are-published-with-the-identical-certificate"></a>Alle apps toepassingsproxy die zijn gepubliceerd met een identiek certificaat
