---
title: Een aangepaste transform-REST versleutelen
...
- [Een Azure Media Services-account maken](./account-create-how-to.md). <br/>Zorg ervoor dat u de naam van de resource groep en de naam van het Media Services account vergeet. 
- [Postman configureren voor Azure Media Services rest API-aanroepen](setup-postman-rest-how-to.md).<br/>Zorg ervoor dat u de laatste stap in het onderwerp [Azure AD-Token ophalen](setup-postman-rest-how-to.md#get-azure-ad-token)volgt. 
