...
2. Klik onder **gegevens bronnen voor werk ruimte** op **ITSM-verbindingen**.
    ...
    ![Nieuwe verbinding](media/itsmc-connections-scsm/add-new-itsm-connection.png)
...
![Service Manager-verbinding](media/itsmc-connections-scsm/service-manager-connection.png)
...
3. Klik onder **hybride verbindingen** op **uw hybride verbindings eindpunten configureren**.
    ...
    ![Netwerk voor hybride verbindingen](media/itsmc-connections-scsm/itsmc-hybrid-connection-networking-and-end-points.png)
4. Klik op de Blade **hybride verbindingen** op **hybride verbinding toevoegen**.

    ![Hybride verbinding toevoegen](media/itsmc-connections-scsm/itsmc-new-hybrid-connection-add.png)

5. Klik op de Blade **hybride verbindingen toevoegen** op **nieuwe hybride verbinding maken**.

    ![Nieuwe hybride verbinding](media/itsmc-connections-scsm/itsmc-create-new-hybrid-connection.png)
...
6. Typ de volgende waarden:
   ...
   - **Naam**: Geef een naam op voor de servicebus als u deze maakt.
     ...
     ![Hybride verbindings waarden](media/itsmc-connections-scsm/itsmc-new-hybrid-connection-values.png)
...
7. Nadat de hybride verbinding is gemaakt, selecteert u de verbinding en klikt u op **geselecteerde hybride verbinding toevoegen**.
    ...
    ![Nieuwe hybride verbinding](media/itsmc-connections-scsm/itsmc-new-hybrid-connection-added.png)
...
![geslaagde hybride verbinding](media/itsmc-connections-scsm/itsmc-hybrid-connection-listener-set-up-successful.png)
> [!NOTE]
> 
...
![Test Hybride verbinding](media/itsmc-connections-scsm/itsmc-hybrid-connection-test.png)
