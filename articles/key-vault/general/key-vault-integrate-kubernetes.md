...
* Voordat u met deze zelfstudie begint, moet u [Azure CLI](/cli/azure/install-azure-cli-windows) installeren.
...
[Over Azure Key Vault](overview.md) 
 ...
 [Stuur programma voor CSI-geheimen](https://secrets-store-csi-driver.sigs.k8s.io/introduction.html)
