...
Azure biedt een set Bibliotheken, genaamd Azure Active Directory-verificatie Bibliotheken, om het proces van het ophalen van een Azure AD-token te vereenvoudigen. Azure bouwt deze bibliotheken voor meerdere talen. Raadpleeg de [documentatie](https://docs.microsoft.com/azure/active-directory/develop/active-directory-authentication-libraries) voor meer informatie.
