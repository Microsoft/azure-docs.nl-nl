...
1. Nadat de conversie is voltooid, vergelijkt u de geconverteerde objecten met de oorspronkelijke objecten om potentiële problemen te identificeren en te verhelpen op basis van de aanbevelingen:
   ...
   ![Code van aanbevelingen controleren](./media/oracle-to-sql-on-azure-vm-guide/procedure-comparison.png)
...
- Het artikel [aan de slag met SQL Server Integration Services](//sql/integration-services/sql-server-integration-services).
