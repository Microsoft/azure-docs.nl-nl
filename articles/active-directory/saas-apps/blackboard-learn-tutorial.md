...
## <a name="add-blackboard-learn-from-the-gallery"></a>School bord toevoegen informatie uit de galerie
...
## <a name="configure-and-test-azure-ad-sso-for-blackboard-learn"></a>Meer informatie over Azure AD SSO voor school bord configureren en testen
...
Voer de volgende stappen uit als u Azure AD SSO wilt configureren en testen met school bord:
...
1. Ga in het Azure Portal **naar de pagina** **school leer informatie over** de integratie van toepassingen en selecteer **eenmalige aanmelding**.
...
In deze sectie wordt een gebruiker met de naam B. Simon gemaakt in school leer. School leer biedt ondersteuning voor Just-in-time-gebruikers inrichting, die standaard is ingeschakeld. Deze sectie bevat geen actie-item voor u. Als een gebruiker nog geen ervaring heeft met school informatie, wordt er na verificatie een nieuwe gemaakt.

## <a name="test-sso"></a>Eenmalige aanmelding testen

In deze sectie test u de configuratie voor eenmalige aanmelding van Azure AD met behulp van de volgende opties. 

* Klik in Azure Portal op **Deze toepassing testen**. Hiermee wordt de aanmeldings-URL van school bord meer omgeleid, waar u de aanmeldings stroom kunt initiëren. 

* Ga naar school bord aanmeldings-URL rechtstreeks en start de aanmeldings stroom vanaf daar.

* U kunt Microsoft Mijn apps gebruiken. Wanneer u op de tegel school bord leren in de mijn apps klikt, wordt dit omgeleid naar school-URL voor aanmelden. Zie [Introduction to My Apps](../user-help/my-apps-portal-end-user-access.md) (Inleiding tot Mijn apps) voor meer informatie over Mijn apps.

## <a name="next-steps"></a>Volgende stappen

Zodra u school bord hebt geconfigureerd, kunt u sessie beheer afdwingen, waardoor exfiltration en infiltratie van de gevoelige gegevens van uw organisatie in real-time worden beschermd. Sessiebeheer is een uitbreiding van voorwaardelijke toegang. [Meer informatie over het afdwingen van sessiebeheer met Microsoft Cloud App Security](/cloud-app-security/proxy-deployment-any-app).