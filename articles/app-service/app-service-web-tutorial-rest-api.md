...
Schakel in Cloud Shell CORS in voor de URL van de client met de opdracht [`az webapp cors add`](/cli/azure/webapp/cors#az_webapp_cors_add). Vervang de tijdelijke aanduiding _&lt;app-naam>_ .
