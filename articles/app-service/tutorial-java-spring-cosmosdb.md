...
Als u deze resources niet nodig hebt voor een andere zelfstudie (zie Volgende [stappen),](#next)kunt u ze verwijderen door de volgende opdracht uit te voeren in de Cloud Shell:Â â€ â€ â 
```azurecli
