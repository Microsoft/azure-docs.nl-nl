...
ms.locfileid: "101705427"
---
<!--Create a thumbnail sprites REST-->

Met de volgende Azure REST-opdracht maakt u een miniatuur van een sprite-getransform. Vervang de waarden `subscriptionID` , `resourceGroup` en `accountName` met de waarden waarmee u momenteel werkt. 

Geef uw trans formatie een naam door in te stellen `transformName` .
