...
Maak een Recovery Services-kluis met [az backup vault create](/cli/azure/backup/vault#az_backup_vault_create). Geef de resourcegroep en locatie op van de VM die u wilt beveiligen. Als u de [Snelstartgids van Virtual Machines](../virtual-machines/linux/quick-create-cli.md) hebt gebruikt, hebt u het volgende gemaakt:
...
U kunt de status van back-uptaken controleren met [az backup job list](/cli/azure/backup/job#az_backup_job_list):
