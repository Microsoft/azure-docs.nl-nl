...
### <a name="q-how-do-i-control-dedicated-sql-pools-serverless-sql-pools-and-serverless-spark-pools"></a>V: Hoe kan ik specifieke SQL-groepen, serverloze SQL-groepen en serverloze Spark-Pools beheren?
