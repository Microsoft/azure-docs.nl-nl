...
- `<application-ID-URI>` -De URI voor de toepassings-id die u hebt ingesteld onder Bewaak **een API** -Blade van de client toepassing.
- `<scope-name>` -De naam van het bereik dat u hebt toegevoegd onder **een API** -Blade van de client toepassing beschikbaar maken.
