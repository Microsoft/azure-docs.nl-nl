---
title: 'Quickstart: Form Recognizer-clientbibliotheek of REST API'
titleSuffix: Azure Cognitive Services
description: Gebruik de clientbibliotheek van Form Recognizer voor REST API voor het maken van een app voor het verwerken van formulieren waarmee sleutel-/waardeparen en tabelgegevens uit uw aangepaste documenten worden geëxtraheerd.
