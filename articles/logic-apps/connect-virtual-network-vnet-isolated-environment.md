...
* Als u geforceerde tunneling via uw firewall instelt om Internet-gebonden verkeer om te leiden, controleert u de [vereisten voor geforceerde tunneling](#forced-tunneling).
...
| Logic Apps Designer: dynamische eigenschappen | **LogicAppsManagement** | * | **VirtualNetwork** | 454 | Aanvragen zijn afkomstig van de [inkomende IP-adressen](../logic-apps/logic-apps-limits-and-config.md#inbound) van het Logic apps toegangs punt voor die regio. <p><p>**Belang rijk**: als u werkt met Azure Government Cloud, werkt het **LogicAppsManagement** -service label niet. In plaats daarvan moet u de Logic Apps [inkomende IP-adressen](../logic-apps/logic-apps-limits-and-config.md#azure-government-inbound) opgeven voor Azure Government. |
| Netwerk status controle | **LogicApps** | * | **VirtualNetwork** | 454 | Aanvragen zijn afkomstig van de [binnenkomende IP-adressen](../logic-apps/logic-apps-limits-and-config.md#inbound) van het Logic apps-eind punt en de [uitgaande IP-adressen](../logic-apps/logic-apps-limits-and-config.md#outbound) voor die regio. <p><p>**Belang rijk**: als u werkt met Azure Government Cloud, werkt het **LogicApps** -service label niet. In plaats daarvan moet u de Logic Apps [inkomende IP-adressen](../logic-apps/logic-apps-limits-and-config.md#azure-government-inbound) en [uitgaande IP-adressen](../logic-apps/logic-apps-limits-and-config.md#azure-government-outbound) voor Azure Government opgeven. |
| Connector implementatie | **AzureConnectors** | * | **VirtualNetwork** | 454 | Vereist voor het implementeren en bijwerken van connectors. Als u deze poort sluit of blokkeert, mislukken de ISE-implementaties en worden updates en oplossingen voor connectors voor komen. <p><p>**Belang rijk**: als u werkt met Azure Government Cloud, werkt het **AzureConnectors** -service label niet. In plaats daarvan moet u de [uitgaande IP-adressen van de beheerde connector](../logic-apps/logic-apps-limits-and-config.md#azure-government-outbound) voor Azure Government opgeven. |
...
* Door de gebruiker gedefinieerde routes
  ...
  Om asymmetrische route ring te voor komen, moet u een route definiëren voor elke en elk IP-adres dat hieronder met **Internet** wordt weer gegeven als de volgende hop.
  
  * [App Service Environment-beheer adressen](../app-service/environment/management-addresses.md)
  * [Azure IP-adressen voor connectors in de ISE-regio, beschikbaar in dit download bestand](https://www.microsoft.com/download/details.aspx?id=56519)
