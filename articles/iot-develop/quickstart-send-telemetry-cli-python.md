...
1. Voer de opdracht [az group delete](https://docs.microsoft.com/cli/azure/group?view=azure-cli-latest#az-group-delete&preserve-view=true) uit. Hiermee verwijdert u de resourcegroep, de IoT Hub en de apparaatregistratie die u hebt gemaakt.
