...
- Geef **ten minste één IP-firewall regel of virtuele-netwerk regel** voor de naam ruimte op om alleen verkeer toe te staan van de opgegeven IP-adressen of het subnet van een virtueel netwerk. Als er geen regels voor IP-en virtueel netwerk zijn, is de naam ruimte toegankelijk via het open bare Internet (met behulp van de toegangs sleutel).  
