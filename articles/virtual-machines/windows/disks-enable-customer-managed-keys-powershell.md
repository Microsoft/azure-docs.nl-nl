...
### <a name="encrypt-an-existing-virtual-machine-scale-set-with-sse-and-customer-managed-keys"></a>Een bestaande schaalset voor virtuele machines versleutelen met SSE en door de klant beheerde sleutels 

Kopieer het script, vervang alle voorbeeld waarden door uw eigen para meters en voer de volgende handelingen uit:
