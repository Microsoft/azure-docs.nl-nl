...
1. **Invoer claims transformeren** : voordat het technische profiel wordt gestart, voert Azure AD B2C invoer [claims Transformation] uit. (claimstransformations.md).
