...
|ReadBodyClaimsOnIdpRedirect| Nee| Instellen op `true` het lezen van claims van antwoord tekst bij het omleiden van de ID-provider. Deze meta gegevens worden gebruikt met [Apple ID](identity-provider-apple-id.md), waar claims retour neren in de reactie lading.|
