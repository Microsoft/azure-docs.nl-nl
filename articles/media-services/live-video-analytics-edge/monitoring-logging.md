...
1. Gebruik docker CLI-opdrachten om het docker-bestand te maken en de installatie kopie naar uw Azure container Registry te publiceren.
   ...
   Zie [push-en pull-installatie kopieën voor docker](https://docs.microsoft.com/azure/container-registry/container-registry-get-started-docker-cli)voor meer informatie over het gebruik van de docker CLI om naar een container register te pushen. Raadpleeg de [documentatie](https://docs.microsoft.com/azure/container-registry/)voor meer informatie over Azure container Registry.
...
1. Nadat de push naar Azure Container Registry is voltooid, voegt u het volgende knoop punt toe aan het manifest bestand van de implementatie:
  ...
  1. Als u Service-Principal-verificatie wilt gebruiken, stelt u deze omgevings variabelen in:  
     ...
     >[!TIP]
     > U kunt de functie voor de uitgever van de **bewakings gegevens** voor de Service-Principal opgeven.
