...
- Door de **[klant beheerde sleutels](../logs/customer-managed-keys.md)** : de cluster gegevens versleutelen met behulp van sleutels die worden verstrekt en beheerd door de klant.
- **[Lockbox](../logs/customer-managed-keys.md#customer-lockbox-preview)** : klanten kunnen micro soft support engineers toegangs aanvragen voor gegevens beheren.
...
- Foutberichten
  ...
  -  400--KeyVaultProperties is niet leeg, maar heeft een ongeldige indeling. Zie [sleutel-id bijwerken](../logs/customer-managed-keys.md#update-cluster-with-key-identifier-details).
  -  400--kan de sleutel in Key Vault niet valideren. Kan worden veroorzaakt door onvoldoende machtigingen of wanneer de sleutel niet bestaat. Controleer of u het [sleutel-en toegangs beleid hebt ingesteld](../logs/customer-managed-keys.md#grant-key-vault-permissions) in Key Vault.
