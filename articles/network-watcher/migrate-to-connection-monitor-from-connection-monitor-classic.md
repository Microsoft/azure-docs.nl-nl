...
* [Migreren van Netwerkprestatiemeter naar verbindings monitor](/azure/network-watcher/migrate-to-connection-monitor-from-network-performance-monitor)
