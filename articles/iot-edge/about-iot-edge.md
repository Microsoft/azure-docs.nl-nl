...
Probeer deze concepten uit door uw eerste IoT Edge-module op een apparaat te implementeren:

<!-- 1.1 -->
:::moniker range="iotedge-2018-06"

* [Modules implementeren op een Linux IoT Edge-apparaat](quickstart-linux.md)
* [Modules implementeren op een Windows IoT Edge-apparaat](quickstart.md)
...
[Modules implementeren op een IoT Edge apparaat](quickstart-linux.md)
