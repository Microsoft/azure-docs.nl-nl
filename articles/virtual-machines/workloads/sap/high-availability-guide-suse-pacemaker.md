...
1. Selecteer Overzicht. Noteer de toepassings-id. Deze wordt gebruikt als de gebruikers naam van de Service-Principal
...
> [!NOTE]
> De optie pcmk_host_map is alleen vereist in de opdracht als de hostnamen en de namen van de Azure-VM'S niet identiek zijn. Geef de toewijzing op in de indeling **hostname: VM-naam**.
> Raadpleeg de sectie vet in de opdracht.
