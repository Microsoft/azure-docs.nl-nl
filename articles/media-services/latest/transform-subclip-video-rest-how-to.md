---
title: Een video afspelen bij het coderen met Media Services REST
...
- [Maak een Azure Media Services-account](./account-create-how-to.md).
...
[Coderen met een aangepaste trans formatie](transform-custom-preset-rest-how-to.md) 
