...
**Hulp**: Azure data share ondersteunt SSO-verificatie met Azure Active Directory (Azure AD). Verminder het aantal identiteiten en referenties dat gebruikers moeten beheren door SSO in te scha kelen voor de service met de bestaande identiteiten van uw organisatie.
...
**Hulp** bij het inschakelen van Azure AD multi-factor Authentication en het volgen van Azure Security Center identiteits-en toegangs aanbevelingen.
