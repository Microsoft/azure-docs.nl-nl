...
In deze hand leiding vindt u informatie over het identificeren en oplossen van bekende problemen in uw geautomatiseerde machine learning experimenten met de [Azure machine learning SDK](/python/api/overview/azure/ml/intro).
...
## <a name="azure-functions-application"></a>Azure Functions toepassing
  
  Automatische ML biedt momenteel geen ondersteuning voor Azure Functions-toepassingen. 
