...
---
# <a name="access-azure-cosmos-db-cassandra-api-data-from-azure-databricks"></a>Toegang tot gegevens van de Azure Cosmos DB Cassandra-API vanuit Azure Databricks
