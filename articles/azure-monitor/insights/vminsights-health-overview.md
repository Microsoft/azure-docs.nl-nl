---
title: Azure Monitor voor VM's van de gast status (preview-versie)
...
ms.locfileid: "94686822"
---
# <a name="azure-monitor-for-vms-guest-health-preview"></a>Azure Monitor voor VM's van de gast status (preview-versie)
