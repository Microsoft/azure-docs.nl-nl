...
1. Voer de volgende opdracht uit om een sleutelkluis te maken met **beveiliging tegen opsluizen** en **soft-delete** ingeschakeld. 
    ...
    ``` 
2. Stel het toegangsbeleid voor de sleutelkluis zo in dat de beheerde identiteit van de Service Bus-naamruimte toegang heeft tot de sleutelwaarde in de sleutelkluis. Gebruik de id van de Service Bus naamruimte uit de vorige sectie. 
