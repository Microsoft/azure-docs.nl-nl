...
* Ondersteuning voor het configureren van [time-out voor LDAP-verbindingen](../articles/active-directory/cloud-provisioning/how-to-manage-registry-options.md#configure-ldap-connection-timeout) 
* Ondersteuning voor het configureren van [referentie Chasing](../articles/active-directory/cloud-provisioning/how-to-manage-registry-options.md#configure-referral-chasing) 
