...
Op aanvraag burstive-cmdlets zijn beschikbaar in versie 2.19.0 en hoger van de [Azure cli-module](https://docs.microsoft.com/cli/azure/install-azure-cli?view=azure-cli-latest). U kunt ook de [Azure Cloud shell](https://shell.azure.com/)gebruiken.
