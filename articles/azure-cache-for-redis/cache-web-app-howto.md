...
2. Voeg `using` boven aan het bestand de volgende-instructies toe.
...
3. Voeg de volgende leden toe aan de `HomeController` klasse ter ondersteuning van een nieuwe `RedisCache` actie die enkele opdrachten uitvoert op de nieuwe cache.
