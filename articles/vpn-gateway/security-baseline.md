...
- [Een op een route gebaseerde VPN-gateway maken met behulp van de Azure Portal](/azure/vpn-gateway/create-routebased-vpn-gateway-portal)
...
- [Activiteiten logboek gebeurtenissen van Azure weer geven en ophalen](/azure/azure-monitor/essentials/activity-log-view)
...
- [Aan de slag met Log Analytics query's](/azure/azure-monitor/logs/get-started-portal) 
...
**Richt lijnen**: gebruik een actief detectie hulpprogramma van derden om alle gevoelige informatie te identificeren die is opgeslagen, verwerkt of verzonden door uw technologie systemen, met inbegrip van degenen die zich op locatie of op een externe service provider bevinden en de gevoelige informatie-inventaris van de organisatie bij te werken.
...
- [Azure CLI voor VPN-gateway](/cli/azure/network/vnet-gateway)
...
Azure Resource Manager kunt de sjabloon in JavaScript Object Notation (JSON) exporteren, die moet worden gecontroleerd om ervoor te zorgen dat de configuraties voldoen aan of de beveiligings vereisten voor uw organisatie overschrijden.
...
**Hulp**: wijs Azure Policy definities toe om resource configuraties te meten die betrekking hebben op uw VPN gateway resources. Gebruik Azure Policy inzichten om resource configuraties te controleren en waarschuwingen te ontvangen over kritieke configuratie wijzigingen.
...
- [Meervoudige verificatie configureren](openvpn-azure-ad-mfa.md)
