---
title: Azure Communication Services Automation API-overzicht van aanroepen
titleSuffix: An Azure Communication Services concept document
description: Biedt een overzicht van de functie en API's voor het aanroepen van Automation.
author: joseys
manager: anvalent
...
ms.locfileid: "107742036"
---
# <a name="call-automation-apis-overview"></a>Overzicht van Automation-API's aanroepen

[!INCLUDE [Private Preview Notice](../../includes/private-preview-include.md)]

Met Automation-API's kunnen organisaties op schaal verbinding maken met hun klanten of werknemers via geautomatiseerde bedrijfslogica. U kunt deze API's gebruiken om geautomatiseerde uitgaande herinneringsoproepen voor afspraken te maken of om proactieve meldingen te geven voor gebeurtenissen zoals stroomuitval of brand. Toepassingen die aan een oproep worden toegevoegd, kunnen updates bewaken wanneer deelnemers deelnemen aan of verlaten, zodat u uitgebreide rapportage- en logboekregistratiemogelijkheden kunt implementeren. 

## <a name="in-call-apis"></a>In-Call API's

> [!NOTE] 
> In-Call worden gefactureerd als gespreksdeelnemers tegen standaardtarieven voor PSTN en VoIP.
                                                        

### <a name="create-call"></a>Aanroep maken
...
```
### <a name="play-audio-in-call"></a>Audio afspelen in aanroep
#### <a name="request"></a>Aanvraag
**HTTP**
<!-- {
  "blockType": "request",
...
```
### <a name="cancel-media-processing"></a>Mediaverwerking annuleren
#### <a name="request"></a>Aanvraag
**HTTP**
<!-- {
  "blockType": "request",
...
```
### <a name="invite-participant"></a>Deelnemer uitnodigen
#### <a name="request"></a>Aanvraag
**HTTP**
<!-- {
  "blockType": "request",
...
```
### <a name="remove-participant"></a>Deelnemer verwijderen
#### <a name="request"></a>Aanvraag
**HTTP**
<!-- {
  "blockType": "request",
...
Bekijk ons voorbeeld [voor](https://github.com/Azure/communication-preview/tree/master/samples/Server-Calling/IncidentReporter) meer informatie.
