...
Azure Media Services v3 is beschikbaar via Azure Resource Manager. Niet alle Media Services-functies zijn echter beschikbaar in alle Azure-Clouds. In dit document wordt een overzicht van de beschik baarheid van belangrijkste Media Services v3-onderdelen beschreven. In de volgende tabellen ziet u welke Media Services-functies beschikbaar zijn in elke regio.  

[!INCLUDE [reference-feature-availability-us](./includes/regions-availability-table-key.md)]

Gebruik de navigatie aan de rechter kant om de gewenste regio te vinden.
