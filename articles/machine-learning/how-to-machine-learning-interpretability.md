...
De klassen interpreteer baarheid van modellen worden beschikbaar gesteld via het volgende SDK-pakket: (informatie over het [installeren van SDK-pakketten voor Azure machine learning](/python/api/overview/azure/ml/install))
