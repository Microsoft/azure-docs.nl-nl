---
title: Azure Monitor voor VM's gast status waarschuwingen (preview-versie)
...
ms.locfileid: "94686745"
---
# <a name="azure-monitor-for-vms-guest-health-alerts-preview"></a>Azure Monitor voor VM's gast status waarschuwingen (preview-versie)
...
Als u proactief een melding wilt ontvangen van een waarschuwing die wordt geactiveerd door de gast status, maakt u een [actie groep](../platform/action-groups.md) om de verschillende acties te definiëren die moeten worden uitgevoerd, zoals het verzenden van een SMS-bericht of het starten van een logische app. Maak vervolgens een [actie regel](../platform/alerts-action-rules.md) waarmee het bereik van monitors en virtuele machines wordt opgegeven en die actie groep wordt gebruikt.
