...
## <a name="create-new-cloud-service-with-single-role-and-certificate-from-key-vault"></a>Nieuwe Cloud service maken met één rol en certificaat van sleutel kluis
