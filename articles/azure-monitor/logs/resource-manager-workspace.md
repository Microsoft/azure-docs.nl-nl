...
Met het volgende voorbeeld wordt een verzameling [Windows-gebeurtenissen](../agents/data-sources-windows-events.md) aan een bestaande werkruimte toegevoegd.
...
Met het volgende voorbeeld wordt een verzameling [syslog-gebeurtenissen](../agents/data-sources-syslog.md) aan een bestaande werkruimte toegevoegd.
...
Met het volgende voorbeeld wordt een verzameling [Windows-prestatiemeteritems](../agents/data-sources-performance-counters.md) aan een bestaande werkruimte toegevoegd.
...
Met het volgende voorbeeld wordt een verzameling [Linux-prestatiemeteritems](../agents/data-sources-performance-counters.md) aan een bestaande werkruimte toegevoegd.
...
Met het volgende voorbeeld wordt een verzameling [aangepaste logboeken](../agents/data-sources-custom-logs.md) aan een bestaande werkruimte toegevoegd.
...
Met het volgende voorbeeld wordt een verzameling [IIS-logboeken](../agents/data-sources-iis-logs.md) aan een bestaande werkruimte toegevoegd.
...
* [Meer informatie over Log Analytics-werkruimten](./quick-create-workspace.md).
* [Meer informatie over agent-gegevensbronnen](../agents/agent-data-sources.md).