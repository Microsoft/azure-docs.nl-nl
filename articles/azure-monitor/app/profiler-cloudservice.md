...
1. Configureer de Azure Diagnostics-extensie om Profiler in te scha kelen:
    ...
    a. Zoek het bestand [Azure Diagnostics](../agents/diagnostics-extension-overview.md) *Diagnostics. wadcfgx* voor uw toepassingsrol, zoals hier wordt weer gegeven:  
