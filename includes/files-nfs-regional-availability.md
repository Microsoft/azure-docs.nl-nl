...
ms.locfileid: "100552686"
---
NFS wordt ondersteund in **alle** 30 + regio's waar opslag van Premium-bestanden beschikbaar is.

Er worden voortdurend regio's toegevoegd. Voor de meest recente lijst gebruikt u het voor beeld hieronder om een query uit te geven op de lijst met regio's met NFS-ondersteuning. U kunt ook controleren op uw regio ondersteuning op [Azure-producten die beschikbaar zijn per regio pagina](https://azure.microsoft.com/global-infrastructure/services/?products=storage&regions=all) onder **Premium files-opslag**.
