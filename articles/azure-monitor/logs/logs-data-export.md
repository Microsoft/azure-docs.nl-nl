...
De gegevens indeling van het opslag account is [JSON-lijnen](../essentials/resource-logs-blob-format.md). Dit betekent dat elke record wordt gescheiden door een nieuwe regel, zonder een matrix van buitenste records en geen komma's tussen JSON-records. 
...
| CommonSecurityLog |  |
| ComputerGroup |  |
| ConfigurationData | Gedeeltelijke ondersteuning: sommige gegevens worden opgenomen via interne services die niet voor export worden ondersteund. Dit gedeelte ontbreekt momenteel in de export. |
...
| DnsInventory |  |
| Dynamics365Activity |  |
| Gebeurtenis | Gedeeltelijke ondersteuning: sommige gegevens voor deze tabel worden opgenomen via het opslag account. Dit gedeelte ontbreekt momenteel in de export. |
...
| OfficeActivity | Gedeeltelijke ondersteuning: enkele van de gegevens die via webhooks van O365 in LA moeten worden opgenomen. Dit gedeelte ontbreekt momenteel in de export. |
| Bewerking | Gedeeltelijke ondersteuning: sommige gegevens worden opgenomen via interne services die niet voor export worden ondersteund. Dit gedeelte ontbreekt momenteel in de export. |
| Prestaties | Gedeeltelijke ondersteuning: alleen Windows-prestatie gegevens worden momenteel ondersteund. De Linux-prestatie gegevens ontbreken momenteel in de export. |
...
| Summary |  |
| SecurityDetection |  |
| SecurityEvent | Gedeeltelijke ondersteuning: sommige gegevens voor deze tabel worden opgenomen via het opslag account. Dit gedeelte ontbreekt momenteel in de export. |
| SecurityIncident |  |
| SecurityIoTRawEvent |  |
...
| SynapseSqlPoolWaits |  |
| Syslog | Gedeeltelijke ondersteuning: sommige gegevens voor deze tabel worden opgenomen via het opslag account. Dit gedeelte ontbreekt momenteel in de export. |
| ThreatIntelligenceIndicator |  |
| Bijwerken | Gedeeltelijke ondersteuning: sommige gegevens worden opgenomen via interne services die niet voor export worden ondersteund. Dit gedeelte ontbreekt momenteel in de export. |
...
| WindowsEvent |  |
| WindowsFirewall |  |
| WireData | Gedeeltelijke ondersteuning: sommige gegevens worden opgenomen via interne services die niet voor export worden ondersteund. Dit gedeelte ontbreekt momenteel in de export. |
| WVDCheckpoints |  |
| WVDConnections |  |
| WVDErrors |  |
| WVDFeeds |  |
...
- [Query's uitvoeren op de geëxporteerde gegevens van Azure Data Explorer](../logs/azure-data-explorer-query-storage.md).
