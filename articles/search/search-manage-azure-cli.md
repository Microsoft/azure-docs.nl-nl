...
Zie voor meer informatie over het maken van privé-eind punten in Power shell deze [koppeling Quick](../private-link/create-private-endpoint-cli.md) start
