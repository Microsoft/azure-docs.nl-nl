...
- [Prestatie meter items](./../agents/data-sources-performance-counters.md) voor Windows & Linux-machines
...
- Logboeken met [gebeurtenis gegevens](./../agents/data-sources-windows-events.md)
