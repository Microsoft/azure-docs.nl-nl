...
> [!NOTE]
> U kunt ook de [IDocumentClient](/dotnet/api/microsoft.azure.documents.idocumentclient) -interface gebruiken om het testen gemakkelijker te maken.
