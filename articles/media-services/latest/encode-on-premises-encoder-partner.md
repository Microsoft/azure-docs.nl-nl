...
2. Maak en start de gebeurtenis **Pass-Through** Live. <br/> Zie [Live Event states and billing](live-event-states-billing-concept.md) (Statussen en facturering voor livegebeurtenissen) voor meer informatie.
...
1. Controleer of het **streaming-eind punt** wordt uitgevoerd In uw Media Services-account. 
2. De live-gebeurtenis voor het **coderen** van Live maken en starten. <br/> Zie [Live Event states and billing](live-event-states-billing-concept.md) (Statussen en facturering voor livegebeurtenissen) voor meer informatie.
...
[Geteste on-premises encoders](encode-recommended-on-premises-live-encoders.md)
