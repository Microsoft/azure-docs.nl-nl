...
Zie voor meer informatie over het maken van privé-eind punten in Power shell deze [koppeling Quick](https://docs.microsoft.com/azure/private-link/create-private-endpoint-powershell) start
