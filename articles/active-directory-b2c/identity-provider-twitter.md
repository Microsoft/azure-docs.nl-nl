...
Op dit moment is de Twitter-ID-provider ingesteld, maar deze is nog niet beschikbaar op de aanmeldings pagina's. De Twitter-ID-provider toevoegen aan een gebruikers stroom:
...
1. Selecteer **Twitter** om u aan te melden met een Twitter-account op de pagina aanmelden of aanmelden.
