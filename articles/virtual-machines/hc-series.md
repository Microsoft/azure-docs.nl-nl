...
Meer informatie over de onderliggende [architectuur, VM-topologie](./workloads/hpc/hc-series-overview.md) en verwachte [prestaties](./workloads/hpc/hc-series-performance.md) van de VM van de HC-serie.
