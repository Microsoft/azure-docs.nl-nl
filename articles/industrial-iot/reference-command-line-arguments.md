---
title: Micro soft OPC Publisher opdracht regel argumenten
description: Dit artikel bevat een overzicht van de OPC Publisher opdracht regel argumenten
author: jehona-m
ms.author: jemorina
...
ms.locfileid: "104787563"
---
# <a name="command-line-arguments"></a>Opdracht regel argumenten

In de volgende velden worden verschillende opdracht regel argumenten beschreven die kunnen worden gebruikt om algemene instellingen voor OPC-Publisher in te stellen.

## <a name="opc-publisher-command-line-arguments-for-version-25-and-below"></a>OPC Publisher opdracht regel argumenten voor versie 2,5 en lager

* Gebruik: opcpublisher.exe \<applicationname> [ \<iothubconnectionstring> ] [ \<options> ]
    
* ApplicationName: de naam van de OPC UA-toepassing die moet worden gebruikt. de naam van de toepassing wordt ook gebruikt om de uitgever onder deze naam te registreren in het IoT Hub Device Registry.
    
* iothubconnectionstring: de IoT Hub eigenaar Connections Tring, optioneel. Normaal gesp roken geeft u de IoTHub owner-Connections Tring alleen op voor het eerst starten van de toepassing. De connection string is versleuteld en opgeslagen in het certificaat archief van het platform.
Bij de volgende aanroepen wordt de Lees bewerking van daaruit gelezen en opnieuw gebruikt. Als u de Connections Tring op elke start opgeeft, wordt het apparaat dat is gemaakt voor de toepassing in het IoT Hub Device REGI ster verwijderd en elke keer opnieuw gemaakt.
    
Er zijn een aantal omgevings variabelen die kunnen worden gebruikt voor het beheren van de toepassing:
```
...
> [!NOTE] 
> Opdracht regel argumenten instellingen voor de omgevings variabele overregelen.
...
## <a name="opc-publisher-command-line-arguments-for-version-26-and-above"></a>OPC Publisher opdracht regel argumenten voor versie 2,6 en hoger
```
      --pf, --publishfile=VALUE
                                       the filename to configure the nodes  to publish.
...
Meer bronnen vindt u in de GitHub-opslag plaatsen:
