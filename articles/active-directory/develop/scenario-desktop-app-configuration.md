---
title: Bureau blad-apps configureren die web-Api's aanroepen | Azure
...
Configuratie parameters kunnen worden geladen uit een groot aantal bronnen, zoals een JSON-bestand of van omgevings variabelen. Hieronder wordt een *. env* -bestand gebruikt. 
...
Laad het *. env* -bestand naar omgevings variabelen. Het MSAL-knoop punt kan mini maal naar beneden worden geïnitialiseerd. Zie de beschik bare [configuratie opties](https://github.com/AzureAD/microsoft-authentication-library-for-js/blob/dev/lib/msal-node/docs/configuration.md).  
