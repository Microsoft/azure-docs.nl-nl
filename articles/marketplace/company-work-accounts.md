...
Zie [een domein toevoegen of koppelen in azure AD](/azure/active-directory/fundamentals/add-custom-domain)voor meer informatie over het toevoegen van aangepaste domeinen in azure Active Directory.
...
![Diagram voor het oplossen van problemen met het aanmelden van een werk account](./media/manage-accounts/onboarding-aad-flow.png)
